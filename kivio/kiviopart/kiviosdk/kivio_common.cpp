...
float XmlReadFloat( const QDomElement &e, const QString &att, const float &def)
{
    ...
    if( !ok )
    {
	kdDebug() << "Invalid XML-value read for " << att.ascii() << ", expected float\n" << endl;
	return 1.0;
    }
...
int XmlReadInt( const QDomElement &e, const QString &att, const int &def)
{
    ...
    if( !ok )
    {
       kdDebug() << "Invalid XML-value read for " << att << " expected int\n" << endl;
	  return 1;
    }
...
uint XmlReadUInt( const QDomElement &e, const QString &att, const uint &def)
{
    ...
    if( !ok )
    {
       kdDebug() << "Invalid XML-value read for " << att.ascii() << ", expected uint\n" << endl;
        return 1;
    }
...
QColor XmlReadColor( const QDomElement &e, const QString &att, const QColor &def)
{
    ...
    if( !ok )
    {
       kdDebug() << "Invalid XML-value read for " << att.ascii() << ", expected QColor" << endl;
        return 1;
    }
...
double XmlReadDouble( const QDomElement &e, const QString &att, const double &def)
{
    ...
    if( !ok )
    {
       kdDebug() << "Invalid XML-value read for ," << att.ascii() << " expected double" << endl;
        return 1.0;
    }
