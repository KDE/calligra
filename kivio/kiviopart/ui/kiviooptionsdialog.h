...
class KivioOptionsDialog : public KDialogBase
{
  ...
  private:
    ...
    QLabel* m_fontTxtLbl;
    QFont m_font;
    KoUnitDoubleSpinBox2* m_spaceHorizUSpin;
    KoUnitDoubleSpinBox2* m_spaceVertUSpin;
    KoUnitDoubleSpinBox2* m_snapHorizUSpin;
    KoUnitDoubleSpinBox2* m_snapVertUSpin;
    ...
    KoUnitDoubleSpinBox2* m_posUSpin;
