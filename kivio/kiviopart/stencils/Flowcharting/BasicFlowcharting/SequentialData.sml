...
<KivioShapeStencil creator="vi">
    <KivioSMLStencilSpawnerInfo>
        ...
        <Title data="Sequential Data"/>
        <Id data="Sequential Data"/>
	...
	<KivioConnectorTarget x="72.0" y="72.0"/>
	<KivioShape type="Ellipse" name="Sequential Data" x="0.0" w="72.0" y="0.0" h="72.0"/>
	<KivioShape type="Polyline" name="Line">
