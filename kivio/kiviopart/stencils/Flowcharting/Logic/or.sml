...
<KivioShapeStencil creator="kate">
		<KivioSMLStencilSpawnerInfo>
			...
			<Title data="Or"/>
			<Id data="Or"/>
			<Description data="Logical Or Gate"/>
			<Version data="0.1"/>
	...
	<KivioConnectorTarget  x="10" y="44"/>
	<KivioConnectorTarget  x="20" y="42.5"/>
	<KivioConnectorTarget  x="30" y="44"/>

	<Dimensions w="40" h="50" defaultAspect="1"/>
