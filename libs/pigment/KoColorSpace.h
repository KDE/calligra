...
public:
     ...
     */
    virtual void fromQColor(const QColor &color, quint8 *dst, const KoColorProfile *profile = nullptr) const = 0;
     ...
     */
    virtual void toQColor(const quint8 *src, QColor *c, const KoColorProfile *profile = nullptr) const = 0;
     ...
     * \<sRGB /\>, \<RGB /\> ... elements. It is assumed that @p colorElt is the \<color /\>
     * element.
     *
