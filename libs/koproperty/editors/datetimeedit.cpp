...
{
    p->eraseRect(r);
    Widget::drawViewer(p, cg, r, KGlobal::locale()->formatDateTime(value.toDateTime(), QLocale::ShortDate, false /*no sec */));
// p->drawText(r, Qt::AlignLeft | Qt::AlignVCenter | Qt::TextSingleLine,
//  KGlobal::locale()->formatDateTime(value.toDateTime(), QLocale::ShortDate, false /*no sec */ ));
}
