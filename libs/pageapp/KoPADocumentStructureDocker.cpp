...
, m_model(0)
{
    ...
    menu->addAction(koIcon("document-new"),
                    ...
                    this, &KoPADocumentStructureDocker::addPage);
    ...
    connect(m_sectionView->selectionModel(), &QItemSelectionModel::selectionChanged,
             this, &KoPADocumentStructureDocker::itemSelected);
