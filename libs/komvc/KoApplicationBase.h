 ...
 */
class KOMVC_EXPORT KoApplicationBase : public QApplication
{
    Q_OBJECT
...
public:
     ...
     */
    KoApplicationBase(int &argc, char **argv);
     ...
     *
     * KoApplicationBase owns the factories.
     */
    bool initialize(KoMainWindowFactory *windowFactory, KoDocumentFactory *documentFactory, KoViewFactory *viewFactory);
