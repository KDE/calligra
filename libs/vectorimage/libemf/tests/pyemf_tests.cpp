...
void PyEmfTests::testPaths1()
{
    ...
    QTest::ignoreMessage(QtDebugMsg,
                         "EMR_POLYLINETO16 QRect(1200,150 151x201) (QPoint(1200,350) ,  QPoint(1250,250) ,  QPoint(1300,350) ,  QPoint(1350,150) )  ");
    ...
    QTest::ignoreMessage(QtDebugMsg,
                         "EMR_POLYLINETO16 QRect(400,950 151x201) (QPoint(400,1150) ,  QPoint(450,1050) ,  QPoint(500,1150) ,  QPoint(550,950) )  ");
    ...
    QTest::ignoreMessage(QtDebugMsg,
                         "EMR_POLYLINETO16 QRect(1200,950 151x201) (QPoint(1200,1150) ,  QPoint(1250,1050) ,  QPoint(1300,1150) ,  QPoint(1350,950) )  ");
    ...
    QTest::ignoreMessage(QtDebugMsg,
                         "EMR_POLYLINETO16 QRect(2000,950 151x201) (QPoint(2000,1150) ,  QPoint(2050,1050) ,  QPoint(2100,1150) ,  QPoint(2150,950) )  ");
...
void PyEmfTests::testPoly2()
{
    ...
    QTest::ignoreMessage(QtDebugMsg,
                         "EMR_POLYGON16 QRect(100,300 851x451) (QPoint(100,400) ,  QPoint(500,700) ,  QPoint(600,400) ,  QPoint(900,700) ,  QPoint(900,400) ,  "
                         "QPoint(100,700) ,  QPoint(100,300) ,  QPoint(950,300) ,  QPoint(950,750) )  ");
    ...
    QTest::ignoreMessage(QtDebugMsg,
                         "EMR_POLYGON16 QRect(100,900 851x451) (QPoint(100,1000) ,  QPoint(500,1300) ,  QPoint(600,1000) ,  QPoint(900,1300) ,  "
                         "QPoint(900,1000) ,  QPoint(100,1300) ,  QPoint(100,900) ,  QPoint(950,900) ,  QPoint(950,1350) )  ");
    QTest::ignoreMessage(QtDebugMsg, "EMR_EOF ");
    Parser parser;
    DebugOutput output;
    parser.setOutput(&output);
...
void PyEmfTests::testViewportWindowOrigin()
{
    ...
    QTest::ignoreMessage(QtDebugMsg,
                         "EMR_POLYLINETO16 QRect(2200,950 151x201) (QPoint(2200,1150) ,  QPoint(2250,1050) ,  QPoint(2300,1150) ,  QPoint(2350,950) )  ");
