...
void KoConnectionShape::saveOdf(KoShapeSavingContext & context) const
{
    ...
    if (d->shape1) {
        context.xmlWriter().addAttribute("draw:start-shape", context.drawId(d->shape1).toString());
    ...
    if (d->shape2) {
        context.xmlWriter().addAttribute("draw:end-shape", context.drawId(d->shape2).toString());
