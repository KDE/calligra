...
public:
    ...
    ~KoAbstractResourceServerAdapter() override = default;
    ...
    virtual QString serverType() const
    {
        return QString();
    }
...
public:
    ...
    QList<KoResource *> resources() override
    {
        ...
        if (cacheDirty) {
            QList<PointerType> serverResources = m_sortingEnabled ? m_resourceServer->sortedResources() : m_resourceServer->resources();
