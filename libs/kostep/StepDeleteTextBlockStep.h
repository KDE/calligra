...
#ifndef STEPDELETETEXTBLOCKSTEP_H
#define STEPDELETETEXTBLOCKSTEP_H

#include "StepStepBase.h"

class StepDeleteTextBlockStep:public StepStepBase
{
public:
...
private:
    class StepDeleteTextBlockStepPrivate * const d;
};

#endif // STEPDELETETEXTBLOCKSTEP_H
