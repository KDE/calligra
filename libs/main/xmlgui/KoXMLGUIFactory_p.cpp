...
ContainerNode::ContainerNode( QWidget *_container, const QString &_tagName,
                              ...
                              KoXMLGUIClient *_client, KoXMLGUIBuilder *_builder,
...
ContainerClient *ContainerNode::findChildContainerClient( KoXMLGUIClient *currentGUIClient,
                                       ...
                                       KoXMLGUIBuilder **builder )
{
    ...
    KoXMLGUIClient *oldClient = m_state.builder->builderClient();
