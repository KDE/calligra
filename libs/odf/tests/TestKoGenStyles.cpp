...
void TestKoGenStyles::testLookup()
{
    ...
    qInfo() << "The first style got assigned the name" << firstName;
    ...
    qInfo() << "The third style got assigned the name" << thirdName;
    ...
    qInfo() << "The 'same as parent' style got assigned the name" << sapName;
...
void TestKoGenStyles:: testUserStyles()
{
    ...
    qInfo() << "The user style got assigned the name" << user1StyleName;
    ...
    qInfo() << "The user style got assigned the name" << user2StyleName;
    ...
    qInfo() << "The different auto style got assigned the name" << dataStyle2Name;
