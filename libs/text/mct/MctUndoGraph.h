...
#ifndef MCTUNDOGRAPH_H
#define MCTUNDOGRAPH_H
...
public:
    ...
    virtual ~MctUndoGraph();

    /**
     * convert and add changeset from redo graph into undo graph
     *
     * @param redochangeset node in the redo graph
     * @return created changeset node.
     */
    MctChangeset* addchangesetFromRedo(MctChangeset* redochangeset);
     ...
     */
    void addChange(MctChange* change, MctChangeset* changeset);
