...
{
    CHECK_EVAL("DURATION_ADD( \"1998-01-01\";  \"2006-01-01\"; 0.08; 0.09; 2; 1 )", Value(5.9943834131)); //
}
...
{
    // 1 Euro to ...
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"ATS\";TRUE())", Value(13.7603));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"BEF\";TRUE())", Value(40.3399));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"DEM\";TRUE())", Value(1.95583));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"ESP\";TRUE())", Value(166.386));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"EUR\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"FIM\";TRUE())", Value(5.94573));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"FRF\";TRUE())", Value(6.55957));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"GRD\";TRUE())", Value(340.75));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"IEP\";TRUE())", Value(0.787564));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"ITL\";TRUE())", Value(1936.27));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"LUX\";TRUE())", Value(40.3399));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"NLG\";TRUE())", Value(2.20371));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"PTE\";TRUE())", Value(200.482));

    // identity
    CHECK_EVAL("EUROCONVERT(1;\"BEF\";\"bef\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"DEM\";\"dem\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"ESP\";\"esp\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"EUR\";\"eur\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"FIM\";\"fim\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"FRF\";\"frf\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"GRD\";\"grd\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"IEP\";\"iep\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"ITL\";\"itl\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"LUX\";\"lux\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"NLG\";\"nlg\";TRUE())", Value(1.0));
    CHECK_EVAL("EUROCONVERT(1;\"PTE\";\"pte\";TRUE())", Value(1.0));

    // all other combinations
    CHECK_EVAL("EUROCONVERT(   2; \"ATS\"; \"bef\";TRUE())", Value(2 * 40.3399 / 13.7603));
    CHECK_EVAL("EUROCONVERT(   3; \"ATS\"; \"dem\";TRUE())", Value(3 * 1.95583 / 13.7603));
    CHECK_EVAL("EUROCONVERT(   4; \"ATS\"; \"esp\";TRUE())", Value(4 * 166.386 / 13.7603));
    CHECK_EVAL("EUROCONVERT(   5; \"ATS\"; \"eur\";TRUE())", Value(5 * 1 / 13.7603));
    CHECK_EVAL("EUROCONVERT(   6; \"ATS\"; \"fim\";TRUE())", Value(6 * 5.94573 / 13.7603));
    CHECK_EVAL("EUROCONVERT(   7; \"ATS\"; \"frf\";TRUE())", Value(7 * 6.55957 / 13.7603));
    CHECK_EVAL("EUROCONVERT(   8; \"ATS\"; \"grd\";TRUE())", Value(8 * 340.75 / 13.7603));
    CHECK_EVAL("EUROCONVERT(   9; \"ATS\"; \"iep\";TRUE())", Value(9 * 0.787564 / 13.7603));
    CHECK_EVAL("EUROCONVERT(  10; \"ATS\"; \"itl\";TRUE())", Value(10 * 1936.27 / 13.7603));
    CHECK_EVAL("EUROCONVERT(  11; \"ATS\"; \"lux\";TRUE())", Value(11 * 40.3399 / 13.7603));
    CHECK_EVAL("EUROCONVERT(  12; \"ATS\"; \"nlg\";TRUE())", Value(12 * 2.20371 / 13.7603));
    CHECK_EVAL("EUROCONVERT(  13; \"ATS\"; \"pte\";TRUE())", Value(13 * 200.482 / 13.7603));
    CHECK_EVAL("EUROCONVERT(  14; \"BEF\"; \"ats\";TRUE())", Value(14 * 13.7603 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  15; \"BEF\"; \"dem\";TRUE())", Value(15 * 1.95583 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  16; \"BEF\"; \"esp\";TRUE())", Value(16 * 166.386 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  17; \"BEF\"; \"eur\";TRUE())", Value(17 * 1 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  18; \"BEF\"; \"fim\";TRUE())", Value(18 * 5.94573 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  19; \"BEF\"; \"frf\";TRUE())", Value(19 * 6.55957 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  20; \"BEF\"; \"grd\";TRUE())", Value(20 * 340.75 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  21; \"BEF\"; \"iep\";TRUE())", Value(21 * 0.787564 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  22; \"BEF\"; \"itl\";TRUE())", Value(22 * 1936.27 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  23; \"BEF\"; \"lux\";TRUE())", Value(23 * 40.3399 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  24; \"BEF\"; \"nlg\";TRUE())", Value(24 * 2.20371 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  25; \"BEF\"; \"pte\";TRUE())", Value(25 * 200.482 / 40.3399));
    CHECK_EVAL("EUROCONVERT(  26; \"DEM\"; \"ats\";TRUE())", Value(26 * 13.7603 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  27; \"DEM\"; \"bef\";TRUE())", Value(27 * 40.3399 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  28; \"DEM\"; \"esp\";TRUE())", Value(28 * 166.386 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  29; \"DEM\"; \"eur\";TRUE())", Value(29 * 1 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  30; \"DEM\"; \"fim\";TRUE())", Value(30 * 5.94573 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  31; \"DEM\"; \"frf\";TRUE())", Value(31 * 6.55957 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  32; \"DEM\"; \"grd\";TRUE())", Value(32 * 340.75 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  33; \"DEM\"; \"iep\";TRUE())", Value(33 * 0.787564 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  34; \"DEM\"; \"itl\";TRUE())", Value(34 * 1936.27 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  35; \"DEM\"; \"lux\";TRUE())", Value(35 * 40.3399 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  36; \"DEM\"; \"nlg\";TRUE())", Value(36 * 2.20371 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  37; \"DEM\"; \"pte\";TRUE())", Value(37 * 200.482 / 1.95583));
    CHECK_EVAL("EUROCONVERT(  38; \"ESP\"; \"ats\";TRUE())", Value(38 * 13.7603 / 166.386));
    CHECK_EVAL("EUROCONVERT(  39; \"ESP\"; \"bef\";TRUE())", Value(39 * 40.3399 / 166.386));
    CHECK_EVAL("EUROCONVERT(  40; \"ESP\"; \"dem\";TRUE())", Value(40 * 1.95583 / 166.386));
    CHECK_EVAL("EUROCONVERT(  41; \"ESP\"; \"eur\";TRUE())", Value(41 * 1 / 166.386));
    CHECK_EVAL("EUROCONVERT(  42; \"ESP\"; \"fim\";TRUE())", Value(42 * 5.94573 / 166.386));
    CHECK_EVAL("EUROCONVERT(  43; \"ESP\"; \"frf\";TRUE())", Value(43 * 6.55957 / 166.386));
    CHECK_EVAL("EUROCONVERT(  44; \"ESP\"; \"grd\";TRUE())", Value(44 * 340.75 / 166.386));
    CHECK_EVAL("EUROCONVERT(  45; \"ESP\"; \"iep\";TRUE())", Value(45 * 0.787564 / 166.386));
    CHECK_EVAL("EUROCONVERT(  46; \"ESP\"; \"itl\";TRUE())", Value(46 * 1936.27 / 166.386));
    CHECK_EVAL("EUROCONVERT(  47; \"ESP\"; \"lux\";TRUE())", Value(47 * 40.3399 / 166.386));
    CHECK_EVAL("EUROCONVERT(  48; \"ESP\"; \"nlg\";TRUE())", Value(48 * 2.20371 / 166.386));
    CHECK_EVAL("EUROCONVERT(  49; \"ESP\"; \"pte\";TRUE())", Value(49 * 200.482 / 166.386));
    CHECK_EVAL("EUROCONVERT(  50; \"EUR\"; \"ats\";TRUE())", Value(50 * 13.7603 / 1));
    CHECK_EVAL("EUROCONVERT(  51; \"EUR\"; \"bef\";TRUE())", Value(51 * 40.3399 / 1));
    CHECK_EVAL("EUROCONVERT(  52; \"EUR\"; \"dem\";TRUE())", Value(52 * 1.95583 / 1));
    CHECK_EVAL("EUROCONVERT(  53; \"EUR\"; \"esp\";TRUE())", Value(53 * 166.386 / 1));
    CHECK_EVAL("EUROCONVERT(  54; \"EUR\"; \"fim\";TRUE())", Value(54 * 5.94573 / 1));
    CHECK_EVAL("EUROCONVERT(  55; \"EUR\"; \"frf\";TRUE())", Value(55 * 6.55957 / 1));
    CHECK_EVAL("EUROCONVERT(  56; \"EUR\"; \"grd\";TRUE())", Value(56 * 340.75 / 1));
    CHECK_EVAL("EUROCONVERT(  57; \"EUR\"; \"iep\";TRUE())", Value(57 * 0.787564 / 1));
    CHECK_EVAL("EUROCONVERT(  58; \"EUR\"; \"itl\";TRUE())", Value(58 * 1936.27 / 1));
    CHECK_EVAL("EUROCONVERT(  59; \"EUR\"; \"lux\";TRUE())", Value(59 * 40.3399 / 1));
    CHECK_EVAL("EUROCONVERT(  60; \"EUR\"; \"nlg\";TRUE())", Value(60 * 2.20371 / 1));
    CHECK_EVAL("EUROCONVERT(  61; \"EUR\"; \"pte\";TRUE())", Value(61 * 200.482 / 1));
    CHECK_EVAL("EUROCONVERT(  62; \"FIM\"; \"ats\";TRUE())", Value(62 * 13.7603 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  63; \"FIM\"; \"bef\";TRUE())", Value(63 * 40.3399 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  64; \"FIM\"; \"dem\";TRUE())", Value(64 * 1.95583 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  65; \"FIM\"; \"esp\";TRUE())", Value(65 * 166.386 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  66; \"FIM\"; \"eur\";TRUE())", Value(66 * 1 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  67; \"FIM\"; \"frf\";TRUE())", Value(67 * 6.55957 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  68; \"FIM\"; \"grd\";TRUE())", Value(68 * 340.75 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  69; \"FIM\"; \"iep\";TRUE())", Value(69 * 0.787564 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  70; \"FIM\"; \"itl\";TRUE())", Value(70 * 1936.27 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  71; \"FIM\"; \"lux\";TRUE())", Value(71 * 40.3399 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  72; \"FIM\"; \"nlg\";TRUE())", Value(72 * 2.20371 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  73; \"FIM\"; \"pte\";TRUE())", Value(73 * 200.482 / 5.94573));
    CHECK_EVAL("EUROCONVERT(  74; \"FRF\"; \"ats\";TRUE())", Value(74 * 13.7603 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  75; \"FRF\"; \"bef\";TRUE())", Value(75 * 40.3399 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  76; \"FRF\"; \"dem\";TRUE())", Value(76 * 1.95583 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  77; \"FRF\"; \"esp\";TRUE())", Value(77 * 166.386 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  78; \"FRF\"; \"eur\";TRUE())", Value(78 * 1 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  79; \"FRF\"; \"fim\";TRUE())", Value(79 * 5.94573 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  80; \"FRF\"; \"grd\";TRUE())", Value(80 * 340.75 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  81; \"FRF\"; \"iep\";TRUE())", Value(81 * 0.787564 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  82; \"FRF\"; \"itl\";TRUE())", Value(82 * 1936.27 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  83; \"FRF\"; \"lux\";TRUE())", Value(83 * 40.3399 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  84; \"FRF\"; \"nlg\";TRUE())", Value(84 * 2.20371 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  85; \"FRF\"; \"pte\";TRUE())", Value(85 * 200.482 / 6.55957));
    CHECK_EVAL("EUROCONVERT(  86; \"GRD\"; \"ats\";TRUE())", Value(86 * 13.7603 / 340.75));
    CHECK_EVAL("EUROCONVERT(  87; \"GRD\"; \"bef\";TRUE())", Value(87 * 40.3399 / 340.75));
    CHECK_EVAL("EUROCONVERT(  88; \"GRD\"; \"dem\";TRUE())", Value(88 * 1.95583 / 340.75));
    CHECK_EVAL("EUROCONVERT(  89; \"GRD\"; \"esp\";TRUE())", Value(89 * 166.386 / 340.75));
    CHECK_EVAL("EUROCONVERT(  90; \"GRD\"; \"eur\";TRUE())", Value(90 * 1 / 340.75));
    CHECK_EVAL("EUROCONVERT(  91; \"GRD\"; \"fim\";TRUE())", Value(91 * 5.94573 / 340.75));
    CHECK_EVAL("EUROCONVERT(  92; \"GRD\"; \"frf\";TRUE())", Value(92 * 6.55957 / 340.75));
    CHECK_EVAL("EUROCONVERT(  93; \"GRD\"; \"iep\";TRUE())", Value(93 * 0.787564 / 340.75));
    CHECK_EVAL("EUROCONVERT(  94; \"GRD\"; \"itl\";TRUE())", Value(94 * 1936.27 / 340.75));
    CHECK_EVAL("EUROCONVERT(  95; \"GRD\"; \"lux\";TRUE())", Value(95 * 40.3399 / 340.75));
    CHECK_EVAL("EUROCONVERT(  96; \"GRD\"; \"nlg\";TRUE())", Value(96 * 2.20371 / 340.75));
    CHECK_EVAL("EUROCONVERT(  97; \"GRD\"; \"pte\";TRUE())", Value(97 * 200.482 / 340.75));
    CHECK_EVAL("EUROCONVERT(  98; \"IEP\"; \"ats\";TRUE())", Value(98 * 13.7603 / 0.787564));
    CHECK_EVAL("EUROCONVERT(  99; \"IEP\"; \"bef\";TRUE())", Value(99 * 40.3399 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 100; \"IEP\"; \"dem\";TRUE())", Value(100 * 1.95583 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 101; \"IEP\"; \"esp\";TRUE())", Value(101 * 166.386 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 102; \"IEP\"; \"eur\";TRUE())", Value(102 * 1 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 103; \"IEP\"; \"fim\";TRUE())", Value(103 * 5.94573 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 104; \"IEP\"; \"frf\";TRUE())", Value(104 * 6.55957 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 105; \"IEP\"; \"grd\";TRUE())", Value(105 * 340.75 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 106; \"IEP\"; \"itl\";TRUE())", Value(106 * 1936.27 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 107; \"IEP\"; \"lux\";TRUE())", Value(107 * 40.3399 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 108; \"IEP\"; \"nlg\";TRUE())", Value(108 * 2.20371 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 109; \"IEP\"; \"pte\";TRUE())", Value(109 * 200.482 / 0.787564));
    CHECK_EVAL("EUROCONVERT( 110; \"ITL\"; \"ats\";TRUE())", Value(110 * 13.7603 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 111; \"ITL\"; \"bef\";TRUE())", Value(111 * 40.3399 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 112; \"ITL\"; \"dem\";TRUE())", Value(112 * 1.95583 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 113; \"ITL\"; \"esp\";TRUE())", Value(113 * 166.386 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 114; \"ITL\"; \"eur\";TRUE())", Value(114 * 1 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 115; \"ITL\"; \"fim\";TRUE())", Value(115 * 5.94573 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 116; \"ITL\"; \"frf\";TRUE())", Value(116 * 6.55957 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 117; \"ITL\"; \"grd\";TRUE())", Value(117 * 340.75 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 118; \"ITL\"; \"iep\";TRUE())", Value(118 * 0.787564 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 119; \"ITL\"; \"lux\";TRUE())", Value(119 * 40.3399 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 120; \"ITL\"; \"nlg\";TRUE())", Value(120 * 2.20371 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 121; \"ITL\"; \"pte\";TRUE())", Value(121 * 200.482 / 1936.27));
    CHECK_EVAL("EUROCONVERT( 122; \"LUX\"; \"ats\";TRUE())", Value(122 * 13.7603 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 123; \"LUX\"; \"bef\";TRUE())", Value(123 * 40.3399 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 124; \"LUX\"; \"dem\";TRUE())", Value(124 * 1.95583 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 125; \"LUX\"; \"esp\";TRUE())", Value(125 * 166.386 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 126; \"LUX\"; \"eur\";TRUE())", Value(126 * 1 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 127; \"LUX\"; \"fim\";TRUE())", Value(127 * 5.94573 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 128; \"LUX\"; \"frf\";TRUE())", Value(128 * 6.55957 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 129; \"LUX\"; \"grd\";TRUE())", Value(129 * 340.75 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 130; \"LUX\"; \"iep\";TRUE())", Value(130 * 0.787564 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 131; \"LUX\"; \"itl\";TRUE())", Value(131 * 1936.27 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 132; \"LUX\"; \"nlg\";TRUE())", Value(132 * 2.20371 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 133; \"LUX\"; \"pte\";TRUE())", Value(133 * 200.482 / 40.3399));
    CHECK_EVAL("EUROCONVERT( 134; \"NLG\"; \"ats\";TRUE())", Value(134 * 13.7603 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 135; \"NLG\"; \"bef\";TRUE())", Value(135 * 40.3399 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 136; \"NLG\"; \"dem\";TRUE())", Value(136 * 1.95583 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 137; \"NLG\"; \"esp\";TRUE())", Value(137 * 166.386 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 138; \"NLG\"; \"eur\";TRUE())", Value(138 * 1 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 139; \"NLG\"; \"fim\";TRUE())", Value(139 * 5.94573 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 140; \"NLG\"; \"frf\";TRUE())", Value(140 * 6.55957 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 141; \"NLG\"; \"grd\";TRUE())", Value(141 * 340.75 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 142; \"NLG\"; \"iep\";TRUE())", Value(142 * 0.787564 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 143; \"NLG\"; \"itl\";TRUE())", Value(143 * 1936.27 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 144; \"NLG\"; \"lux\";TRUE())", Value(144 * 40.3399 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 145; \"NLG\"; \"pte\";TRUE())", Value(145 * 200.482 / 2.20371));
    CHECK_EVAL("EUROCONVERT( 146; \"PTE\"; \"ats\";TRUE())", Value(146 * 13.7603 / 200.482));
    CHECK_EVAL("EUROCONVERT( 147; \"PTE\"; \"bef\";TRUE())", Value(147 * 40.3399 / 200.482));
    CHECK_EVAL("EUROCONVERT( 148; \"PTE\"; \"dem\";TRUE())", Value(148 * 1.95583 / 200.482));
    CHECK_EVAL("EUROCONVERT( 149; \"PTE\"; \"esp\";TRUE())", Value(149 * 166.386 / 200.482));
    CHECK_EVAL("EUROCONVERT( 150; \"PTE\"; \"eur\";TRUE())", Value(150 * 1 / 200.482));
    CHECK_EVAL("EUROCONVERT( 151; \"PTE\"; \"fim\";TRUE())", Value(151 * 5.94573 / 200.482));
    CHECK_EVAL("EUROCONVERT( 152; \"PTE\"; \"frf\";TRUE())", Value(152 * 6.55957 / 200.482));
    CHECK_EVAL("EUROCONVERT( 153; \"PTE\"; \"grd\";TRUE())", Value(153 * 340.75 / 200.482));
    CHECK_EVAL("EUROCONVERT( 154; \"PTE\"; \"iep\";TRUE())", Value(154 * 0.787564 / 200.482));
    CHECK_EVAL("EUROCONVERT( 155; \"PTE\"; \"itl\";TRUE())", Value(155 * 1936.27 / 200.482));
    CHECK_EVAL("EUROCONVERT( 156; \"PTE\"; \"lux\";TRUE())", Value(156 * 40.3399 / 200.482));
    CHECK_EVAL("EUROCONVERT( 157; \"PTE\"; \"nlg\";TRUE())", Value(157 * 2.20371 / 200.482));
    CHECK_EVAL("EUROCONVERT(100;\"EUR\";\"DEM\")", Value(195.58));
    CHECK_EVAL("EUROCONVERT(100;\"EUR\";\"BEF\")", Value(4034));
    CHECK_EVAL("EUROCONVERT(100;\"ATS\";\"EUR\";FALSE();3)", Value(7.27));
    CHECK_EVAL("EUROCONVERT(100;\"ATS\";\"EUR\";FALSE();2)", Value::errorVALUE());
    CHECK_EVAL("ORG.OPENOFFICE.CONVERT(100;\"ATS\";\"EUR\")", Value(7.26728341678597));
    CHECK_EVAL("ORG.OPENOFFICE.CONVERT(100;\"EUR\";\"skK\")", Value::errorVALUE());
}
...
{
    // ODF
    CHECK_EVAL_SHORT("INTRATE( DATE(2002; 6;8); DATE(1995;10;5); 100000; 200000; 0 )",
                     Value::errorVALUE()); // Settlement date must be before the maturity date.
    CHECK_EVAL_SHORT("INTRATE( DATE(2002; 6;8); DATE(2002; 6;8); 100000; 200000; 0 )",
                     Value::errorVALUE()); // Settlement date must be before the maturity date.
...
void TestFinancialFunctions::testODDLPRICE()
{
    ...
    CHECK_EVAL_SHORT("ODDLPRICE(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);2%;1.5%;100;1;1)", Value(102.5118179883)); // f=1, b=1
    CHECK_EVAL_SHORT("ODDLPRICE(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);2%;1.5%;100;2;1)", Value(102.5118179883)); // f=2, b=1
    CHECK_EVAL_SHORT("ODDLPRICE(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);2%;1.5%;100;4;1)", Value(102.5118179883)); // f=4, b=1
    CHECK_EVAL_SHORT("ODDLPRICE(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);2%;1.5%;100;1;2)", Value(102.5444975699)); // f=1, b=2
    ...
    CHECK_EVAL_SHORT("ODDLPRICE(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);3%;5%;1000;1;3)", Value(794.497205855)); // f=1, b=3
    CHECK_EVAL_SHORT("ODDLPRICE(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);3%;5%;1000;2;3)", Value(794.497205855)); // f=2, b=3
    CHECK_EVAL_SHORT("ODDLPRICE(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);3%;5%;1000;4;3)", Value(794.497205855)); // f=4, b=3
...
void TestFinancialFunctions::testODDLYIELD()
{
    ...
    // Basis 1
    CHECK_EVAL_SHORT("ODDLYIELD(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);2%;103;100 ;1;1)", Value(1.4087410785 / 100.0)); // With Frequency=1 and Basis=1
    ...
    // Basis 2
    CHECK_EVAL_SHORT("ODDLYIELD(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);2%;103;100;1;2)", Value(1.4159710376 / 100.0)); // With Frequency=1 and Basis=2
    CHECK_EVAL_SHORT("ODDLYIELD(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);2%;103;100 ;4;2)", Value(1.4159710376 / 100.0)); // With Frequency=2 and Basis=2
    CHECK_EVAL_SHORT("ODDLYIELD(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);2%;103;100 ;2;2)", Value(1.4159710376 / 100.0)); // With Frequency=4 and Basis=2

    // Basis 3
    CHECK_EVAL_SHORT("ODDLYIELD(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);3%;795;1000;1;3)", Value(4.985538985 / 100.0)); // With Frequency=1 and Basis=3
    CHECK_EVAL_SHORT("ODDLYIELD(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);3%;795;1000;2;3)", Value(4.985538985 / 100.0)); // With Frequency=2 and Basis=3
    CHECK_EVAL_SHORT("ODDLYIELD(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);3%;795;1000;4;3)", Value(4.985538985 / 100.0)); // With Frequency=4 and Basis=3
...
void TestFinancialFunctions::testPDURATION()
{
    ...
    CHECK_EVAL_SHORT("PDURATION( 0.1; 100; 10 )", Value(-24.158858)); // currentValue > desiredValue
...
void TestFinancialFunctions::testPPMT()
{
    ...
    CHECK_EVAL("PPMT(3%;1;12;100;200;1)", Value(-23.4355588756)); // With future value and type
}
...
void TestFinancialFunctions::testPRICEMAT()
{
    ...
    CHECK_EVAL_SHORT("PRICEMAT(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);6%;5%;1)", Value(103.8224430356)); // With Basis=1 specs 103.824693325
    ...
    CHECK_EVAL_SHORT("PRICEMAT(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1);6%;5%;4)", Value(103.8177326528)); // With Basis=4
...
void TestFinancialFunctions::testTBILLPRICE()
{
    ...
    CHECK_EVAL("TBILLPRICE(DATE(1995;12;31);DATE(1996;12;31);5%)", Value(Value::errorVALUE())); // ODF specs 94.91666667 OOo-2.2.1 94.98611111
    ...
    CHECK_EVAL("TBILLPRICE(DATE(1996;01;01);DATE(1997;01;01);5%)", Value(Value::errorVALUE())); // ODF specs 94.91666667 OOo-2.2.1 94.98611111
...
void TestFinancialFunctions::testVDB()
{
    ...
    CHECK_EVAL("VDB(10000;600;10;4.875;5.875;1.5)", Value(769.36046875));
...
void TestFinancialFunctions::testYIELDMAT()
{
    ...
    //   CHECK_EVAL_SHORT( "YIELDMAT(DATE(1990;6;1);DATE(1992;12;31);DATE(1990;1;1); 6%;103.817732653;4)", Value( 0.050000000  ) ); // With Basis=4 NOK diff =
    //   0.0074805
    CHECK_EVAL_SHORT("YIELDMAT(DATE(1990;6;1);DATE(1992;12;31);DATE(1990;1;1); 3%;102.395007924;0)", Value(0.020000000)); // With Basis=0
    //   CHECK_EVAL_SHORT( "YIELDMAT(DATE(1990;6;1);DATE(1995;12;31);DATE(1990;1;1); 5%;102.967175933;2)", Value( 0.030000000  ) ); // With Basis=2 NOK diff =
    //   -0.0126036
