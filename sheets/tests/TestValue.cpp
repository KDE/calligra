...
void TestValue::testArray()
{
    ...
    v2 = Value(v1); // v2 is now also an array
    v1 = Value(v2.element(0, 0));
    QCOMPARE(v1.type(), Value::Float);
