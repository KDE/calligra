...
public:
    ...
    Value sumIfs(QList<Value> range,
                 QList<Condition> cond, const float limit);
    Value averageIf(const Value &range, const Condition &cond, const Value &aRange);
    //Value averageIf(const Cell &avgRangeStart,
    //            const Value &checkRange, const Condition &cond);
    Value averageIfs(const Value &avgRange,
    ...
    Value countIfs(QList<Value> range, QList<Condition> cond, const float limit);
