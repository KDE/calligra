 ...
 */
class KOFAKE_EXPORT KPasswordDialog : public QDialog
{
    Q_OBJECT
...
public:
     ...
     * @since 4.1
     */
    QString domain() const {return QString();}
     ...
     * @since 4.1
     */
    bool anonymousMode() const { return false; }
     ...
     */
    bool keepPassword() const { return true; }
...
protected:
     ...
     */
    virtual bool checkPassword() { return false; }
