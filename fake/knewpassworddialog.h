...
class KOFAKE_EXPORT KNewPasswordDialog
    : public QDialog
{
    Q_OBJECT
...
public:
     ...
     */
    explicit KNewPasswordDialog(QWidget *parent=0) : QDialog(parent) {}
     ...
     */
    bool allowEmptyPasswords() const { return true;}
     ...
     * Minimum acceptable password length.
     */
    int minimumPasswordLength() const { return 0;}
     ...
     * Maximum acceptable password length.
     */
    int maximumPasswordLength() const { return 0; }
     ...
     * Password length that is expected to be reasonably safe.
     */
    int reasonablePasswordLength() const { return 0; }
     ...
     */
    int passwordStrengthWarningLevel() const { return 0; }
...
protected:
     ...
     */
    virtual bool checkPassword(const QString &) { return false; }
     ...
     * @since 4.2
     */
    bool checkAndGetPassword(QString *pwd) { return false; }
