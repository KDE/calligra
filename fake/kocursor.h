...
/**
 * The KoCursor class provides a set of static
 * convenience methods for auto-hiding cursors on widgets.
 */
class KOFAKE_EXPORT KoCursor
{
public:
    /**
    ...
    /**
     * KoCursor has to install an eventFilter over the widget you want to
     ...
     *         KoCursor::autoHideEventFilter( o, e );
     *
     ...
     * \endcode
     *
     * Note that you must not call KoCursor::autoHideEventFilter() when you
