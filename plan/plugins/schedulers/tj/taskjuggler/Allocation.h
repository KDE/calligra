...
public:
    ...
    void setLockedResource(Resource *r)
    {
        lockedResource = r;
    }
    Resource *getLockedResource() const
    {
        return lockedResource;
    }

    void addCandidate(Resource *r)
    {
        candidates.append(r);
    }
    ...
    QList<Resource *> getCandidates() const
    {
        return candidates;
    }

    /// Return the list of required resources for @p resource
    QList<Resource *> getRequiredResources(Resource *r) const
    {
        return requiredResources.value(r);
    }
    ...
    bool hasRequiredResources(Resource *resource) const
    {
        return requiredResources.contains(resource);
    }
    ...
    void setSelectionMode(SelectionModeType smt)
    {
        selectionMode = smt;
    }
    ...
    void setConflictStart(time_t cs)
    {
        conflictStart = cs;
    }
