...
public:
    ...
    void resetCounters()
    {
        warnings = errors = infos = debugs = 0;
    }
    void reset()
    {
        resetCounters();
    ...
    bool isWarning(int messagePos) const
    {
        return warningPositions.contains(messagePos);
    }
    int getWarnings() const
    {
        return warnings;
    }
    QString getWarningMessage(int pos) const
    {
        return getMessage(warningPositions.value(pos));
    }

    bool isError(int messagePos) const
    {
        return errorPositions.contains(messagePos);
    }
    int getErrors() const
    {
        return errors;
    }
    QString getErrorMessage(int pos) const
    {
        return getMessage(errorPositions.value(pos));
    }

    bool isInfo(int messagePos) const
    {
        return infoPositions.contains(messagePos);
    }
    ...
    QString getInfoMessage(int pos) const
    {
        return getMessage(infoPositions.value(pos));
    }

    bool isDebug(int messagePos) const
    {
        return debugPositions.contains(messagePos);
    }
    ...
    QString getDebugMessage(int pos) const
    {
        return getMessage(debugPositions.value(pos));
    }
    ...
    QString getMessage(int pos) const
    {
        return messages.value(pos);
    }
