...
Duration::Duration(double value, Duration::Unit unit)
{
    if (unit == Unit_ms) {
        ...
        m_ms = (qint64)(value * 1000);
    } else if (unit == Unit_m) {
        m_ms = (qint64)(value * (1000 * 60));
    } else if (unit == Unit_h) {
        m_ms = (qint64)(value * (1000 * 60 * 60));
    } else if (unit == Unit_d) {
        m_ms = (qint64)(value * (1000 * 60 * 60 * 24));
    } else if (unit == Unit_w) {
        m_ms = (qint64)(value * (1000 * 60 * 60 * 24 * 7));
    } else if (unit == Unit_M) {
        m_ms = (qint64)(value * (qint64)(1000 * 60 * 60) * (24 * 30));
    } else if (unit == Unit_Y) {
        m_ms = (qint64)(value * (qint64)(1000 * 60 * 60) * (24 * 365));
    }
}
...
double Duration::toDouble(Unit u) const
{
    if (u == Unit_ms) {
        ...
        return (double)m_ms / 1000.0;
    } else if (u == Unit_m) {
        return (double)m_ms / (1000.0 * 60.0);
    } else if (u == Unit_h) {
        return (double)m_ms / (1000.0 * 60.0 * 60.0);
    } else if (u == Unit_d) {
        return (double)m_ms / (1000.0 * 60.0 * 60.0 * 24.0);
    } else if (u == Unit_w) {
        return (double)m_ms / (1000.0 * 60.0 * 60.0 * 24.0 * 7.0);
    } else if (u == Unit_M) {
        return (double)m_ms / (1000.0 * 60.0 * 60.0 * 24.0 * 30);    //Month
    } else if (u == Unit_Y) {
        return (double)m_ms / (1000.0 * 60.0 * 60.0 * 24.0 * 365);    // Year
    }
    return (double)m_ms;
}
