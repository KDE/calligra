...
public:
    ...
    {
        return m_parent == 0 ? false : m_parent->recalculate();
    }
    virtual DateTime recalculateFrom() const
    {
        return m_parent == 0 ? DateTime() : m_parent->recalculateFrom();
    }

    virtual long parentScheduleId() const
    {
        return m_parent == 0 ? NOTSCHEDULED : m_parent->parentScheduleId();
    }
    ...
    int calculationMode() const
    {
        return m_calculationMode;
    }
    /// Return the list of appointments
    QList<Appointment *> appointments() const
    {
    ...
    void setResourceError(bool on)
    {
        resourceError = on;
    }
    void setResourceOverbooked(bool on)
    {
        resourceOverbooked = on;
    }
    void setResourceNotAvailable(bool on)
    {
        resourceNotAvailable = on;
    }
    void setConstraintError(bool on)
    {
        constraintError = on;
    }
    void setNotScheduled(bool on)
    {
        notScheduled = on;
    }
    void setSchedulingError(bool on)
    {
        schedulingError = on;
    }

    void setPositiveFloat(const Duration &f)
    {
        positiveFloat = f;
    }
    void setNegativeFloat(const Duration &f)
    {
        negativeFloat = f;
    }
    void setFreeFloat(const Duration &f)
    {
        freeFloat = f;
    }

    void setInCriticalPath(bool on = true)
    {
        inCriticalPath = on;
    }

    virtual ScheduleManager *manager() const
    {
        return 0;
    }
...
public:
    ...
    void setNodeSchedule(const Schedule *sch)
    {
        m_nodeSchedule = sch;
    }
...
public:
    ...
    {
        m_softconstraints.append(node);
    }
    QList<Node *> softConstraints() const
    {
        return m_softconstraints;
    }
    ...
    const QList< QList<Node *> > *criticalPathList() const
    {
        return &(m_pathlists);
    }
    ...
    void setLog(const QList<Schedule::Log> &log)
    {
        m_log = log;
    }
    ...
    void setPhaseName(int phase, const QString &name)
    {
        m_logPhase[ phase ] = name;
    }
    QString logPhase(int phase) const
    {
        return m_logPhase.value(phase);
    }
    ...
    void setPhaseNames(const QMap<int, QString> &pn)
    {
        m_logPhase = pn;
    }
...
public:
    ...
    void setManagerId(const QString &id)
    {
        m_id = id;
    }
    ...
    ScheduleManager *parentManager() const
    {
        return m_parent;
    }
    ...
    ScheduleManager *childAt(int index) const
    {
    ...
    void setRecalculate(bool on)
    {
        m_recalculate = on;
    }
    /// The datetime this schedule will be calculated from
    DateTime recalculateFrom() const
    {
        return m_recalculateFrom;
    }
    /// Set the datetime this schedule will be calculated from to @p dt
    void setRecalculateFrom(const DateTime &dt)
    {
        m_recalculateFrom = dt;
    }
    long parentScheduleId() const
    {
        return m_parent == 0 ? NOTSCHEDULED : m_parent->scheduleId();
    }
    ...
    bool isScheduled() const
    {
        return m_expected == 0 ? false :  m_expected->isScheduled();
    }

    void setExpected(MainSchedule *sch);
    MainSchedule *expected() const
    {
        return m_expected;
    }
    ...
    bool schedulingDirection() const
    {
        return m_schedulingDirection;
    }
    ...
    int calculationResult() const
    {
        return m_calculationresult;
    }
    void setCalculationResult(int r)
    {
        m_calculationresult = r;
    }
