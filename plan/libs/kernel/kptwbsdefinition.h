...
public:
    ...
    public:
        CodeDef() {}
        CodeDef(const QString &c, const QString &s)
        {
            code = c;
            separator = s;
        }
    ...
    void setDefaultDef(const CodeDef &def)
    {
        m_defaultDef = def;
    }
    ...
    QMap<int, CodeDef> levelsDef() const
    {
        return m_levelsDef;
    }
    ...
    void setProjectCode(const QString &str)
    {
        m_projectCode = str;
    }
    QString projectSeparator() const
    {
        return m_projectSeparator;
    }
    void setProjectSeparator(const QString &str)
    {
        m_projectSeparator = str;
    }
