...
public:
    ...
    virtual bool load(KoXmlElement &, XMLLoaderObject &)
    {
        return true;
    }
    ...
    {
        return m_dependChildNodes.count();
    }
    ...
    QList<Relation *> dependChildNodes() const
    {
        return m_dependChildNodes;
    }

    int numDependParentNodes() const
    {
        return m_dependParentNodes.count();
    }
    ...
    QList<Relation *> dependParentNodes() const
    {
        return m_dependParentNodes;
    }
    ...
    virtual ResourceGroupRequest *resourceGroupRequest(const ResourceGroup * /*group*/) const
    {
        return 0;
    }
    ...
    virtual Duration plannedEffort(const QDate &, long id = CURRENTSCHEDULE, EffortCostCalculationType = ECCT_All) const
    {
        Q_UNUSED(id);
        return Duration::zeroDuration;
    }
    ...
    virtual Duration plannedEffortTo(const QDate &, long id = CURRENTSCHEDULE, EffortCostCalculationType = ECCT_All) const
    {
        Q_UNUSED(id);
        return Duration::zeroDuration;
    }
    ...
    virtual double budgetedCostPerformed(const QDate &, long = CURRENTSCHEDULE) const
    {
        return 0.0;
    };
    ...
    virtual double bcwp(long id) const
    {
        Q_UNUSED(id);
        return 0.0;
    }
    ...
    virtual bool legalToLink(const Node *, const Node *) const
    {
        return false;
    }
    ...
    const ResourceRequestCollection &requests() const
    {
        return m_requests;
    }
    ResourceRequestCollection &requests()
    {
        return m_requests;
    }

    virtual uint state(long) const
    {
        return State_None;
    }
...
public:
    ...
    virtual void changed(int property = -1)
    {
        changed(this, property);
    }
    Duration getmDurationForward()
    {
        return this->m_durationForward;
    }
