...
public:
    ...
    ScheduleManager *manager() const
    {
        return m_nodemodel.manager();
    }
    long id() const
    {
        return m_nodemodel.id();
    }
    ...
    bool projectShown() const
    {
        return m_projectshown;
    }
...
public:
    ...
    void setShowSpecial(bool on)
    {
        m_showSpecial = on;
    }
    bool showSpecial() const
    {
        return m_showSpecial;
    }
...
public:
    ...
    bool filterUnscheduled() const
    {
        return m_filterUnscheduled;
    }
