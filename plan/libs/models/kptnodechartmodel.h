...
public:
    ...
    void setRejectColumns(const QList<int> &columns)
    {
        m_rejects = columns;
        invalidateFilter();
    }
    QList<int> rejectColumns() const
    {
        return m_rejects;
    }
    void setZeroColumns(const QList<int> &columns)
    {
        m_zerocolumns = columns;
    }
    QList<int> zeroColumns() const
    {
        return m_zerocolumns;
    }
...
//    virtual Qt::ItemFlags flags( const QModelIndex & index ) const;
    ...
    const EffortCostMap &bcwp() const
    {
        return m_bcws;
    }
    const EffortCostMap &acwp() const
    {
        return m_acwp;
    }
