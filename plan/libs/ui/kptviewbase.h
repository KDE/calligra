...
public:
    ...
    {
        return m_actionListMap[name];
    }
    /// Add an action to the specified action list
    void addAction(const QString &list, QAction *action)
    {
        m_actionListMap[list].append(action);
    }

    virtual QList<QAction *> viewlistActionList() const
    {
        return m_viewlistActionList;
    }
    void addViewlistAction(QAction *action)
    {
        m_viewlistActionList.append(action);
    }

    QList<QAction *> contextActionList() const
    {
        return m_contextActionList;
    }
...
public:
    ...
    {
        m_arrowKeyNavigation = on;
    }
    bool arrowKeyNavigation() const
    {
        return m_arrowKeyNavigation;
    }
    ...
    void setAcceptDropsOnView(bool mode)
    {
        m_acceptDropsOnView = mode;
    }
    ...
    */
    ...
    void setDefaultColumns(const QList<int> &lst)
    {
        m_defaultColumns = lst;
    }
    QList<int> defaultColumns() const
    {
...
public:
    ...
    void hideColumn(int col)
    {
        ...
        if (m_rightview) {
            m_rightview->hideColumn(col);
        }
    }
    void showColumn(int col)
    {
        if (col == 0 || m_rightview == 0) {
            m_leftview->showColumn(col);
        } else {
            m_rightview->showColumn(col);
        }
    }
    ...
    TreeViewBase *masterView() const
    {
        return m_leftview;
    }
    TreeViewBase *slaveView() const
    {
        return m_rightview;
    }
    ...
    KAction *actionSplitView() const
    {
        return m_actionSplitView;
    }
