...
public:
    ...
    virtual ReportData *clone() const
    {
        return 0;
    }
    ...
    bool isMainDataSource() const
    {
        return m_maindatasource;
    }
    bool isSubDataSource() const
    {
        return m_subdatasource;
    }
    void setSubDataSources(QList<ReportData *> &lst)
    {
        m_subdatasources = lst;
    }
