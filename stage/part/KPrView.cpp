...
#include "dockers/KPrAnimationsDocker.h"
#include "dockers/KPrAnimationsDockerFactory.h"
...
void KPrView::initGUI()
{
    ...
    if (shell()) {
        ...
        //Animations Docker
        KPrAnimationsDockerFactory animationsFactory;
        KPrAnimationsDocker *animationsDocker = qobject_cast<KPrAnimationsDocker*>(shell()->createDockWidget(&animationsFactory));
        animationsDocker->setView( this );
    }
