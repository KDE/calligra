...
KChartDocument::KChartDocument( QWidget *parentWidget,
                                QObject* parent,
                                bool singleViewMode )
...
//
void KChartDocument::initNullChart()
{
...
void KChartDocument::generateBarChartTemplate()
{
    int  col;
    int  row;

    kDebug()<<"KChartDocument::generateBarChartTemplate()";
...
#if 0
KoView* KChartDocument::createViewInstance( QWidget* parent )
{
...
void KChartDocument::paintContent( QPainter& painter, const QRect& rect)
{
#if 0
    int  numDatasets;
...
//
int  KChartDocument::createDisplayData()
{
    int  rowOffset   = 0;
    int  colOffset   = 0;
    int  numDatasets = 0;
...
#if 0
void KChartDocument::createLabelsAndLegend( QStringList  &longLabels,
					QStringList  &shortLabels )
{
    longLabels.clear();
    shortLabels.clear();
...
void KChartDocument::analyzeHeaders()
{
#if 0
...
// KSpread.
//
void KChartDocument::analyzeHeaders( const QStandardItemModel &data )
{
    Q_UNUSED( data );
#if 0
...
void KChartDocument::doSetData( const QStandardItemModel &data,
			    bool  firstRowHeader,
			    bool  firstColHeader )
{
    Q_UNUSED( data );
...
void KChartDocument::resizeData( int rows, int cols )
{
    Q_UNUSED( rows );
    Q_UNUSED( cols );
...
void KChartDocument::setCellData( int row, int column, const QVariant &val)
{
    Q_UNUSED( row );
    Q_UNUSED( column );
    Q_UNUSED( val );
...
void KChartDocument::initLabelAndLegend()
{
...
void KChartDocument::setChartDefaults()
{
#if 0
  //
...
void KChartDocument::loadConfig( KConfig *config )
{
    Q_UNUSED( config );
#if 0
...
void KChartDocument::defaultConfig(  )
{
    //FIXME
#if 0
    delete m_params;
...
void KChartDocument::saveConfig( KConfig *config )
{
    Q_UNUSED( config );
#if 0
    KConfigGroup conf = config->group("ChartParameters");
...
bool KChartDocument::loadOasis( const KoXmlDocument& doc,
...
bool KChartDocument::loadOasisData( const KoXmlElement& tableElem )
{
    Q_UNUSED( tableElem );
#if 0
...
bool KChartDocument::saveOasis( KoStore* store, KoXmlWriter* manifestWriter )
{
    Q_UNUSED( store );
...
void KChartDocument::saveOasisData( KoXmlWriter* bodyWriter,
...
void KChartDocument::writeAutomaticStyles( KoXmlWriter& contentWriter, KoGenStyles& mainStyles ) const
{
...
QDomDocument KChartDocument::saveXML()
{
#if 0
    QDomElement  tmpElem;
...
bool KChartDocument::loadXML( QIODevice*, const KoXmlDocument& doc )
{
    Q_UNUSED( doc );
...
//
bool KChartDocument::loadAuxiliary( const KoXmlDocument& doc )
{
...
#if 0
bool KChartDocument::loadData( const KoXmlDocument& doc )
{
...
#if 0
bool KChartDocument::loadOldXML( const KoXmlDocument& doc )
{
...
void  KChartDocument::slotModified()
{
...
bool KChartDocument::showEmbedInitDialog(QWidget* /*parent*/)
{
