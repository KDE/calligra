...
int main( int argc, char **argv )
{
	...
	KChartWidget cw2;
	cw2.setChartData( &data2 );
	cw2.chart()->setXLabel( "X Label" );
	cw2.chart()->setYLabel( "Y Label" );
	cw2.chart()->setTitle( "Two data sets" );
	cw2.chart()->setYMaxValue( 40 );
	cw2.chart()->setYTicksNum( 8 );
	cw2.chart()->setYLabelSkip( 2 );
