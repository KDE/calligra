...
int KoColor::R() const { if( !m_RGBvalid ) calcRGB(); return m_R; }
int KoColor::G() const { if( !m_RGBvalid ) calcRGB(); return m_G; }
int KoColor::B() const { if( !m_RGBvalid ) calcRGB(); return m_B; }
int KoColor::h() const { if( !m_HSVvalid ) calcHSV(); return m_H; }
int KoColor::s() const { if( !m_HSVvalid ) calcHSV(); return m_S; }
int KoColor::v() const { if( !m_HSVvalid ) calcHSV(); return m_V; }
int KoColor::l() const { if( !m_LABvalid ) calcLAB(); return m_L; }
int KoColor::a() const { if( !m_LABvalid ) calcLAB(); return m_a; }
int KoColor::b() const { if( !m_LABvalid ) calcLAB(); return m_b; }
int KoColor::c() const { if( !m_CMYKvalid ) calcCMYK(); return m_C; }
int KoColor::m() const { if( !m_CMYKvalid ) calcCMYK(); return m_M; }
int KoColor::y() const { if( !m_CMYKvalid ) calcCMYK(); return m_Y; }
int KoColor::k() const { if( !m_CMYKvalid ) calcCMYK(); return m_K; }
