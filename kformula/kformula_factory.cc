...
KFormulaFactory::KFormulaFactory( QObject* parent )
    : KoFactory( parent )
{
...
KParts::Part* KFormulaFactory::createPartObject( QWidget *parentWidget, QObject* parent, const char* classname, const QStringList & )
{
