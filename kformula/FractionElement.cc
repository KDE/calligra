...
FractionElement::FractionElement(FormulaClass *Formula,BasicElement *Prev=0L,int Relation=-1,BasicElement *Next=0L,
...
void FractionElement::draw(QPoint drawPoint,int resolution=72)
{
...
int FractionElement::takeAsciiFromKeyb(int action)
{
  return 2;
}
int FractionElement::takeActionFromKeyb(int action)
{
  return -1;
}
