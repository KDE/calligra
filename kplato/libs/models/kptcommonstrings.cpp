...
namespace KPlato
{
    ...
    QString ToolTip::nodeSchedulingStatus() { return i18n( "Shows the tasks scheduling status" ); }
    QString ToolTip::nodeNotScheduled() { return i18n( "The task has not been scheduled" ); }
