...
#ifndef KPLATO_PLOTAXIS_H
#define KPLATO_PLOTAXIS_H
...
/**
     * @short Axis for KPlotWidget.  KPlato extensions to KPlotAxis.
 *
 ...
 * @version 1.0
 */
class KPLATOUI_EXPORT KPlotAxis {
public:
...
protected:
    void setDateTickMarks( double x0, double length );
    void setWeekTickMarks( double x0, double length );
