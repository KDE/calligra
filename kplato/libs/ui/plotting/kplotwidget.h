...
#ifndef KPLATO_PLOTWIDGET_H
#define KPLATO_PLOTWIDGET_H
 ...
 *@class KPlotWidget
 *
 *@short Generic data plotting widget. KPlato extensions to KPlotWidget.
 *
 ...
 *@version 1.1
 */
class KPLATOUI_EXPORT KPlotWidget : public QFrame {
    Q_OBJECT
