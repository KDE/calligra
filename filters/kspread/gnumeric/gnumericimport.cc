...
void GNUMERICFilter::setStyleInfo(QDomNode * sheet, Sheet * table)
{
    ...
    if ( !styles.isNull() )
    {
        ...
        while ( !style_region.isNull() )
        {
            ...
            QDomNode gnumericStyle = style_region.namedItem( "gmr:Style" );
            QDomNode font = gnumericStyle.namedItem( "gmr:Font" );
            QDomNode validation = gnumericStyle.namedItem( "gmr:Validation" );
            QDomNode gmr_styleborder = gnumericStyle.namedItem( "gmr:StyleBorder" );
            QDomNode hyperlink = gnumericStyle.namedItem( "gmr:HyperLink" );
                        ...
                        if ( !validation_element.isNull() )
                        {
                            ...
                            if ( validation_element.hasAttribute( "Style" ) )
                            {
                                ...
                                case 0:
                                    ...
                                    break;
                                case 1:
                                  kspread_validity->setAction( Action::Stop );
                                    break;
                                case 2:
                                  kspread_validity->setAction( Action::Warning );
                                    break;
                                case 3:
                                  kspread_validity->setAction( Action::Information );
                                    break;
                                default:
                            ...
                            if ( validation_element.hasAttribute( "Type" ) )
                            {
                                ...
                                {
                                case 0:
                                    kspread_validity->setRestriction( Restriction::None );
                                    break;
                                case 1:
                                {
                                    kspread_validity->setRestriction( Restriction::Integer );
                                ...
                                break;
                                case 2:
                                    kspread_validity->setRestriction( Restriction::Number );
                                    if ( validation_element.hasAttribute( "Operator" ) )
                                    {
                                        int value = validation_element.attribute( "Operator" ).toInt();
                                        switch( value )
                                    ...
                                    break;
                                case 3:
                                    kspread_validity->setRestriction( Restriction::List );
                                    break;
                                case 4:
                                    kspread_validity->setRestriction( Restriction::Date );
                                    if ( validation_element.hasAttribute( "Operator" ) )
                                    {
                                        int value = validation_element.attribute( "Operator" ).toInt();
                                        switch( value )
                                    ...
                                    break;
                                case 5:
                                    kspread_validity->setRestriction( Restriction::Time );
                                    if ( validation_element.hasAttribute( "Operator" ) )
                                    {
                                        int value = validation_element.attribute( "Operator" ).toInt();
                                        switch( value )
                                    ...
                                    break;
                                case 6:
                                    kspread_validity->setRestriction( Restriction::TextLength );
                                    if ( validation_element.hasAttribute( "Operator" ) )
                                    {
                                        int value = validation_element.attribute( "Operator" ).toInt();
                                        switch( value )
