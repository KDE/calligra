...
/* NOTE: As of now everything is in a single huge function.  This is
	 ...
	 of grow out of control.  It could probably be cleaned up in
	 an hour or so. --PGE
  */


const bool GNUMERICFilter::I_filter(const QString &file, KoDocument *document,
