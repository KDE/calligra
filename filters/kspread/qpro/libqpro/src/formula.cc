...
// {31, NA
   ...
   {96,  QpFormula::func1,         "@dvar("},
   {97,  QpFormula::func1,         "@dstd("},
   {98,  QpFormula::func1,         "@index2d("},
   {99,  QpFormula::func1,         "@cols("},
   {100, QpFormula::func1,         "@rows("},
   {101, QpFormula::func1,         "@repeat("},
   {102, QpFormula::func1,         "@upper("},
   {103, QpFormula::func1,         "@lower("},
   {104, QpFormula::func1,         "@left("},
   {105, QpFormula::func1,         "@right("},
   {106, QpFormula::func1,         "@replace("},
   {107, QpFormula::func1,         "@proper("},
   {108, QpFormula::func1,         "@cell("},
   ...
   {115, QpFormula::func1,         "@@("},
   {116, QpFormula::func1,         "@rate("},
   {117, QpFormula::func1,         "@term("},
   {118, QpFormula::func1,         "@cterm("},
   {119, QpFormula::func1,         "@sln("},
   {120, QpFormula::func1,         "@syd("},
   {121, QpFormula::func1,         "@ddb("},
