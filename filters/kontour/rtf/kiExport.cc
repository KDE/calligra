...
/***************************************************************************/
// Globals
kiDraw          kilDraw;        // create an instance of kiDraw to process
                                // tag data
double          units = 20.0;
...
// function is ProcessSpreadsheetTag and can be called with the node
// returned
...
void ProcessKillustratorTag(QDomNode myNode,
                            void *tagData, QString & outputText)
// Gets the attributes for the DOC tag and calls it's subtag processors
{
    ...
    attrProcessingList
        << AttrProcessing("editor", "QString", (void *) &docinfo->editor)
    ...
    tagProcessingList
        << TagProcessing("head", ProcessHeadTag, (void *) &head)
...
void kiProcessPageTag(QDomNode myNode, void *, QString & outputText)
// Gets the PAGE tag and calls it's subtag processors
{
    ...
    QValueList < TagProcessing > tagProcessingList;
    tagProcessingList
        << TagProcessing("layout", kiProcessLayoutTag, (void *) &layout)
...
// called by ProcessPageTag()
{
    ...
    QValueList < AttrProcessing > attrProcessingList;
    attrProcessingList
        << AttrProcessing("format", "QString", (void *) &layout->format)
    ...
    if (layout->unit == "pica")
        units = 240.0;
    if (layout->unit == "didot")
        units = 18.69;
    if (layout->unit == "cicero")
        units = 224.3;
...
void ProcessHeadTag(QDomNode myNode, void *tagData, QString & outputText)
...
// called by ProcesszKillustratorTag()
{
    ...
    QValueList < TagProcessing > tagProcessingList;
    tagProcessingList
        << TagProcessing("grid", ProcessGridTag, (void *) &grid)
...
// called by ProcessGridTag()
{
    ...
    QValueList < TagProcessing > tagProcessingList;
    tagProcessingList << TagProcessing("hl", ProcessHlvlTag,
                                       (void *) &helplines->
                                       hl) << TagProcessing("vl",
                                                            ProcessHlvlTag,
                                                            (void *)
...
void ProcessInfoTag(QDomNode myNode, void *tagData, QString &)
// Gets the attributes in the info tag - information on author, creation,
// modification
// called by ProcessHeadTag()
{
    ...
    QValueList < AttrProcessing > attrProcessingList;
    attrProcessingList
        << AttrProcessing("author", "QString", (void *) &info->author)
...
void ProcessHlvlTag(QDomNode myNode, void *tagData, QString &)
...
void ProcessGridTag(QDomNode myNode, void *tagData, QString & outputText)
...
// called by ProcessHeadTag()
{
    ...
    QValueList < AttrProcessing > attrProcessingList;
    attrProcessingList
        << AttrProcessing("dx", "QString", (void *) &dx)
...
// called by ProcessdocTag() or ProcessGroupTag()
{
    ...
    QValueList < AttrProcessing > attrProcessingList;
    attrProcessingList
        << AttrProcessing("arrow1", "int", (void *) &polyline->arrow1)
        << AttrProcessing("arrow2", "int", (void *) &polyline->arrow2);
    ProcessAttributes(myNode, attrProcessingList);

    QValueList < TagProcessing > tagProcessingList;
    tagProcessingList
        << TagProcessing("point", ProcessPointTag, (void *) &polyline->point)
...
void ProcessPolygonTag(QDomNode myNode, void *, QString & outputText)
...
void ProcessRectangleTag(QDomNode myNode, void *, QString & outputText)
// Gets the attributes and subtags of the polygon tag
// called by ProcessdocTag() or ProcessGroupTag()
{
    Rectangle       rectangle;
    ...
    QValueList < AttrProcessing > attrProcessingList;
    attrProcessingList
        << AttrProcessing("x", "QString", (void *) &x)
...
void ProcessBezierTag(QDomNode myNode, void *, QString & outputText)
...
void ProcessEllipseTag(QDomNode myNode, void *, QString & outputText)
...
// called by ProcessPolylineTag() or ProcessEllipseTag()
{
    ...
    QValueList < AttrProcessing > attrProcessingList;
    attrProcessingList
        << AttrProcessing("strokecolor", "QString", (void *) &gobject->strokecolor)
    ...
    ProcessSubtags(myNode, tagProcessingList, outputText);
    kdDebug(30505) << "strokecolor " << gobject->strokecolor << " fillcolor " << gobject->fillcolor << " gradcolor1 " << gobject->gradcolor1 << endl;

}                               // end ProcessGobjectTag()

/***************************************************************************/

void ProcessMatrixTag(QDomNode myNode, void *tagData, QString &)
...
void kiProcessFontTag(QDomNode myNode, void *tagData, QString &)
...
void kiProcessTextTag(QDomNode myNode, void *tagData, QString & outputText)
...
// called by ProcessLayerTag()
{
    ...
    QValueList < TagProcessing > tagProcessingList;
    tagProcessingList
        << TagProcessing("gobject", ProcessGobjectTag, (void *) &text->gobject)
...
void ProcessPointTag(QDomNode myNode, void *tagData, QString &)
// Gets the attributes in the matrix tag
// called by ProcessGobjectTag()
{
...
void ProcessLayerTag(QDomNode myNode, void *, QString & outputText)
...
void ProcessGroupTag(QDomNode myNode, void *tagData, QString & outputText)
// Processes the subtags of the layer tag
// Called by ProcessKillustratorTag()
{
