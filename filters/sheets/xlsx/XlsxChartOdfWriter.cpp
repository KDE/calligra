...
QString XlsxChartOdfWriter::genChartAreaStyle(KoGenStyle &style, KoGenStyles &styles, KoGenStyles &mainStyles)
{
...
QString XlsxChartOdfWriter::genPlotAreaStyle(KoGenStyle &style, KoGenStyles &styles, KoGenStyles &mainStyles)
{
    KoChart::AreaFormat *areaFormat =
        ((chart()->m_plotArea && chart()->m_plotArea->m_areaFormat && chart()->m_plotArea->m_areaFormat->m_fill) ? chart()->m_plotArea->m_areaFormat
                                                                                                                 : chart()->m_areaFormat);
...
void XlsxChartOdfWriter::addDataThemeToStyle(KoGenStyle &style, int dataNumber, int maxNumData, bool strokes)
{
    if (!m_theme)
        return;
    ...
    fadePatterns << fadepatternOne << fadepatternTwo << fadepatternThree << fadepatternFour << fadepatternFive << fadepatternSix;
