...
public:
    ...
    enum SpecialCharacter {
        ...
        AbbreviatedDate = 10,
        TimeHMS = 11,
        CurrentSectionNumber = 12,
        AbbreviatedDayOfWeek = 14,
        DayOfWeek = 15,
        DayShort = 16,
        HourCurrentTime = 22,
        HourCurrentTimeTwoDigits = 23,
        MinuteCurrentTime = 24,
        MinuteCurrentTimeTwoDigits = 25,
        SecondsCurrentTime = 26,
        AMPMCurrentTime = 27,
        CurrentTimeHMSOld = 28,
        DateM = 29,
        DateShort = 30,
        MonthShort = 33,
        YearLong = 34,
     ...
     * invokes the functor.
     */
    virtual void footnoteFound(FootnoteData data,
                               UString characters,
     ...
     * invokes the functor.
     */
    virtual void annotationFound(UString characters, SharedPtr<const Word97::CHP> chp, const AnnotationFunctor &parseAnnotation);
