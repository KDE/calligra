...
private:
    ...
    private:
        ...
        void
        addTextStyles(const MSO::OfficeArtClientTextBox *clientTextbox, const MSO::OfficeArtClientData *clientData, KoGenStyle &style, Writer &out) override;
    ...
    public:
        explicit DrawClient(WordsGraphicsHandler *p)
            : gh(p)
        {
        }
    };
...
private:
     ...
     * TODO:
     */
    void locateDrawing(const MSO::OfficeArtSpgrContainer *o, wvWare::Word97::FSPA *spa, uint spid, DrawingWriter &out);
    /**
