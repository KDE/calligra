...
#ifndef KWEF_WORDSLEADER_H
#define KWEF_WORDSLEADER_H
...
class WORDS_LIBEXPORT_EXPORT KWEFWordsLeader
{
public:
    explicit KWEFWordsLeader(void);
    KWEFWordsLeader(KWEFBaseWorker* newWorker);
    virtual ~KWEFWordsLeader(void);
public:
