 ...
 */
WordsLatexExportDia::WordsLatexExportDia(KoStore* in, QWidget* parent,
        ...
        : LatexExportDia(parent, name_, modal, fl), _in(in)
{
    ...
    /* Recent files */
    _config = new KConfig("wordslatexexportdialog");
    _config->setGroup("Words latex export filter");
    QString value;
    while (i < 10) {
 ...
 */
WordsLatexExportDia::~WordsLatexExportDia()
{
    delete _iface;
    delete _config;
}
 ...
 */
void WordsLatexExportDia::reject()
{
 ...
 */
void WordsLatexExportDia::accept()
{
    hide();
    kDebug(30522) << "WORDS LATEX EXPORT FILTER --> BEGIN";
    ...
    kDebug(30522) << "WORDS LATEX EXPORT FILTER --> END";
}

void WordsLatexExportDia::addLanguage()
{
...
void WordsLatexExportDia::removeLanguage()
{
...
#include <wordslatexexportdia.moc>
