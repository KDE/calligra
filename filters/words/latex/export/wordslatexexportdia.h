...
#ifndef __WORDSLATEXEXPORTDIA_H__
#define __WORDSLATEXEXPORTDIA_H__
...
class WordsLatexExportDia : public LatexExportDia
{
    Q_OBJECT
...
public:
    explicit WordsLatexExportDia(KoStore*, QWidget* parent = 0,
                                 const char* name = 0, bool modal = true, Qt::WFlags fl = 0);
    virtual ~WordsLatexExportDia();
...
#endif /* __WORDSLATEXEXPORTDIA_H__ */
