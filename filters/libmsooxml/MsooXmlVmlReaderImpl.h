...
KoFilter::ConversionStatus MSOOXML_CURRENT_CLASS::read_line()
{
    ...
    qreal fromX = QStringView{temp}.left(temp.size() - 2).toDouble();
    ...
    qreal fromY = QStringView{temp}.left(temp.size() - 2).toDouble();
    ...
    qreal toX = QStringView{temp}.left(temp.size() - 2).toDouble() - fromX;
    ...
    unit = temp.right(2);
    qreal toY = QStringView{temp}.left(temp.size() - 2).toDouble() - fromY;
