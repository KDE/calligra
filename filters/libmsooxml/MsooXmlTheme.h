...
public:
    ...
    QColor color;
    DrawingMLColorSchemeItem *clone() const
    {
...
public:
    ...
    DrawingMLColorSchemeSystemItem *clone() const
    {
...
public:
    ...
    DrawingMLSolidFill *clone() const
    {
...
public:
    ...
    DrawingMLGradientFill *clone() const
    {
