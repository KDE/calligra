...
private:
    ...
    void processObject(const MSO::OfficeArtSpgrContainer& o, Writer& out);
    void processObject(const MSO::OfficeArtSpContainer& o, Writer& out);
    /**
...
public:
    ...
    void processObject(const MSO::OfficeArtSpgrContainerFileBlock& o, Writer& out);
