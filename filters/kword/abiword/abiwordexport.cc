...
/*
   This file is based on the old file:
    koffice/filters/kword/ascii/asciiexport.cc
...
static void ProcessSubtags ( QDomNode parentNode, QValueList<TagProcessing>  &tagProcessingList, QString &outputText )
{
    QDomNode childNode;
...
static void AllowNoSubtags ( QDomNode  myNode )
{
    QString outputText;
...
static void ProcessAttributes ( QDomNode myNode, QValueList<AttrProcessing> &attrProcessingList )
{
...
static void AllowNoAttributes ( QDomNode  myNode )
{
...
static bool writeOutputFileGZipped(const QString& filename, const QCString& strOut)
{
    ...
    { //We have a problem
        ...
        kdError() << "Unable to write gzipped output file!" << num << "/" << strOut.length() << endl;
    	return false;
    }
