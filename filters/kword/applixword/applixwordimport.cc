...
const bool APPLIXWORDImport::filter(const QString &fileIn, const QString &fileOut,
        ...
        else if ( c == QChar ('^') )
	{
	  //str += "XX ";
          ...
          if ( ( c1 == QChar ('p') )  &&  ( c2 == QChar ('m') ) )
            str += "ue"; //"&uuml;";
          if ( ( c1 == QChar ('n') )  &&  ( c2 == QChar ('m') ) )
            str += "Ue"; //"&Uuml;";

          if ( ( c1 == QChar ('o') )  &&  ( c2 == QChar ('e') ) )
            {str += "ae"; /*"&auml;";*/ printf ("habe ä gefunden\n");}

          if ( ( c1 == QChar ('p') )  &&  ( c2 == QChar ('g') ) )
            str += "oe"; //"&ouml;";

          if ( ( c1 == QChar ('n') )  &&  ( c2 == QChar ('p') ) )
            str += "sz"; //"&szlig;";
