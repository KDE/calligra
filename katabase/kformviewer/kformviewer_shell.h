...
#ifndef __kformviewer_shell_h__
#define __kformviewer_shell_h__
...
class KformViewerShell : public KoMainWindow
{
  Q_OBJECT
...
public:
  ...
  void setDocument( KformViewerDoc* _doc );
...
protected:
  ...
  KformViewerView* m_pView;

  static QList<KformViewerShell>* s_lstShells;
};
