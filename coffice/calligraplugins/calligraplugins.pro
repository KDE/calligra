...
CALLIGRAPLUGINS_KDCHART_DIR = $${TOP_SOURCE_DIR}/../3rdparty/kdchart/src
...
INCLUDEPATH = \
     ...
     $${CALLIGRAPLUGINS_KDCHART_DIR} \
     $${CALLIGRAPLUGINS_KDCHART_DIR}/LeveyJennings/ \
     $${CALLIGRAPLUGINS_KDCHART_DIR}/PrerenderedElements/ \
     $${CALLIGRAPLUGINS_KDCHART_DIR}/Scenery/ \
     $${CALLIGRAPLUGINS_KDCHART_DIR}/Ternary/ \
...
#SOURCES += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/*.cpp)
#SOURCES += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/LeveyJennings/*.cpp)
#SOURCES += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/PrerenderedElements/*.cpp)
#SOURCES += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/Scenery/*.cpp)
#SOURCES += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/Ternary/*.cpp)

#HEADERS += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/*.h)
#HEADERS += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/LeveyJennings/*.h)
#HEADERS += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/PrerenderedElements/*.h)
#HEADERS += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/Scenery/*.h)
#HEADERS += $$files($$CALLIGRAPLUGINS_KDCHART_DIR/Ternary/*.h)
