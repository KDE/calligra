...
{
public:
    KGuiItem( const QString &text, const QString &iconName = QString(), const QString &toolTip = QString(), const QString &whatsThis = QString() ) : m_text(text), m_tooltip(toolTip), m_whatsThis(whatsThis), m_enable(true) {}
    KGuiItem( const QString &text, const KIcon &icon, const QString &toolTip = QString(), const QString &whatsThis = QString() ) : m_text(text), m_tooltip(toolTip), m_whatsThis(whatsThis), m_icon(icon), m_enable(true) {}
