...
#ifndef KEXIDBWIDGETFACTORY_H
#define KEXIDBWIDGETFACTORY_H

#include "formeditor/widgetfactory.h"

class KexiDBWidgetFactory : public KFormDesigner::WidgetFactory
{
	Q_OBJECT

	public:
		KexiDBWidgetFactory(QObject *parent, const char *name);
		~KexiDBWidgetFactory();
