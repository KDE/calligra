...
{
    KAboutData *about = new KAboutData("kformdesigner_kdev_part", 0, ki18n("Form Designer Part"), "0.3");
    return about;
}
...
KFormDesignerKDevPart::setupActions()
{
    ...
    new KAction(i18n("Preview Form"), "document-print-preview", "Ctrl+T", this, SLOT(slotPreviewForm()), actionCollection(), "preview_form");
...
{
    KUrl url = KFileDialog::getSaveURL("kfiledialog:///kformdesigner", i18n("*.ui|Qt Designer UI Files"), m_workspace);
    if (url.isEmpty())
        return;
    else
