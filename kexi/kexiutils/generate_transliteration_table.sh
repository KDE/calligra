...
#
# Generates a transliteration_table.h file using recode's "flat" character set
#

out="transliteration_table.h.orig"
max=65534
...
static const char *const transliteration_table[TRANSLITERATION_TABLE_SIZE + 1] = {" > $out;
