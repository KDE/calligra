...
KoUnitDoubleSpinBox::KoUnitDoubleSpinBox( QWidget *parent, const char *name )
    : KDoubleSpinBox( parent, name ), KoUnitDoubleBase( KoUnit::Point, 2 )
...
{
  m_stepInPoints = KoUnit::toUserValue(step, KoUnit::Point );
...
KoUnitDoubleLineEdit::KoUnitDoubleLineEdit( QWidget *parent, const char *name )
    : KLineEdit( parent, name ), KoUnitDoubleBase( KoUnit::Point, 2 ), m_value( 0.0 ), m_lower( 0.0 ), m_upper( 9999.99 ),
    m_lowerInPoints( 0.0 ), m_upperInPoints( 9999.99 )
{
    ...
    setUnit( KoUnit::Point );
    changeValue(  KoUnit::ptToUnit( 0.0, KoUnit::Point ) );
}
...
KoUnitDoubleComboBox::KoUnitDoubleComboBox( QWidget *parent, const char *name )
     : KComboBox( true, parent, name ), KoUnitDoubleBase( KoUnit::Point, 2 ), m_value( 0.0 ), m_lower( 0.0 ), m_upper( 9999.99 ), m_lowerInPoints( 0.0 ), m_upperInPoints( 9999.99 )
{
    ...
    : QWidget( parent ), m_step( 1.0 )
{
    ...
    m_combo = new KoUnitDoubleComboBox( this, KoUnit::ptToUnit( 0.0, KoUnit::Point ), KoUnit::ptToUnit( 9999.99, KoUnit::Point ), 0.0, KoUnit::Point, 2, name );
