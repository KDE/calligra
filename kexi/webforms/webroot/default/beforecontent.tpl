...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
  <head>
    ...
    <meta name="description" content="Kexi Web Forms page" />
  ...
  <body  id="cp-site-wwwkdeorg">
	...
	<div id="header_bottom">
	  <div id="location">
	    <ul>
	      <li><a href="/" accesskey="1">Main page</a></li>
	    </ul>
	  </div>

	  <div id="menu">
	    <ul>
	      <li><a href="http://www.kexi-project.org/">Kexi website</a></li>
	      <!--<li><a href="">Send bug report</a></li>-->
	    </ul>
	  </div>
	</div>
      </div>
