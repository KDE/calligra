#! /bin/sh
rm -f tips.cpp
EXCLUDE="-path ./formeditor -o -path ./doc -o -path ./plugins/importwizard -o -path ./tests -o -path ./scriptingplugins -o -path ./plugins/scripting -o -path ./plugins/reports -o -path ./3rdparty -o -path ./shapes"
