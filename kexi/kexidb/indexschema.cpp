...
IndexSchema::IndexSchema()
	...
	, m_primary(0)
{
	//fields are not owned by IndexSchema object!
...
const QString& IndexSchema::name() const
{
	return m_name;
}

void IndexSchema::setName(const QString& name)
{
	m_name=name;
}
...
IndexSchema::IndexSchema(const QString & name, Connection *conn)
	: m_conn( conn )
	, m_name( name )
	, m_primary( false )
...
bool IndexSchema::isPrimary()
{
	return m_primary;
}

bool IndexSchema::isAutoGenerated()
{
