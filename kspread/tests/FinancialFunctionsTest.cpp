...
void FinancialFunctionsTest::testDDB()
{
	...
	CHECK_EVAL( "DDB(2400; 300; 10*365; 1; 2)", 1.3150684931506848585 ) ;
	CHECK_EVAL( "DDB(2400; 300; 10*12; 1; 2)", 40.0 ) ;
	CHECK_EVAL( "DDB(2400; 300; 10; 1; 2)", 480.0 ) ;
	CHECK_EVAL( "DDB(2400; 300; 10; 2; 1.5)", 306 ) ;
	CHECK_EVAL( "DDB(2400; 300; 10; 10; 2)", 22.12254720000009911 ) ;
	
	// http://www.vni.com/products/imsl/jmsl/v30/api/com/imsl/finance/ddbEx1.html
  CHECK_EVAL( "DDB(2500; 500; 24; 1; 2)",  208.33333333333331 );
  CHECK_EVAL( "DDB(2500; 500; 24; 2; 2)",  190.97222222222220 );
  CHECK_EVAL( "DDB(2500; 500; 24; 3; 2)",  175.05787037037035 );
  CHECK_EVAL( "DDB(2500; 500; 24; 4; 2)",  160.46971450617283 );
  CHECK_EVAL( "DDB(2500; 500; 24; 5; 2)",  147.09723829732508 );
  CHECK_EVAL( "DDB(2500; 500; 24; 6; 2)",  134.83913510588133 );
  CHECK_EVAL( "DDB(2500; 500; 24; 7; 2)",  123.60254051372456 );
  CHECK_EVAL( "DDB(2500; 500; 24; 8; 2)",  113.30232880424752 );
  CHECK_EVAL( "DDB(2500; 500; 24; 9; 2)",  103.86046807056023 );
  CHECK_EVAL( "DDB(2500; 500; 24; 10; 2)",  95.20542906468020 );
  CHECK_EVAL( "DDB(2500; 500; 24; 11; 2)",  87.27164330929020 );
  CHECK_EVAL( "DDB(2500; 500; 24; 12; 2)",  79.99900636684936 );
  CHECK_EVAL( "DDB(2500; 500; 24; 13; 2)",  73.33242250294525 );
  CHECK_EVAL( "DDB(2500; 500; 24; 14; 2)",  67.22138729436648 );
  CHECK_EVAL( "DDB(2500; 500; 24; 15; 2)",  61.619605019835944404 );
  CHECK_EVAL( "DDB(2500; 500; 24; 16; 2)",  56.484637934849615704 );
  CHECK_EVAL( "DDB(2500; 500; 24; 17; 2)",  51.77758477361215 );
  CHECK_EVAL( "DDB(2500; 500; 24; 18; 2)",  47.46278604247781 );
  CHECK_EVAL( "DDB(2500; 500; 24; 19; 2)",  43.50755387227133 );
  CHECK_EVAL( "DDB(2500; 500; 24; 20; 2)",  39.881924382915386218 );
  CHECK_EVAL( "DDB(2500; 500; 24; 21; 2)",  36.55843068433910 );
  CHECK_EVAL( "DDB(2500; 500; 24; 22; 2)",  33.51189479397749 );
  ...
  CHECK_EVAL( "DDB(2500; 500; 24; 22)",  33.51189479397749 );
  CHECK_EVAL( "DDB(2500; 500; 24; 23)",  30.719236894479383437 );
  CHECK_EVAL( "DDB(2500; 500; 24; 24)",  -162.08839416072669337 );
}
