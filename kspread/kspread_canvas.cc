...
void KSpreadCanvas::scrollToCell(QPoint location)
{
  ...
  */
  ...
  //do we need to scroll right
    ...
    unsigned long horzScrollBarValueMax = int( table->sizeMaxX() * zoom() ) - width();
  ...
  // do we need to scroll down
    ...
    unsigned long vertScrollBarValueMax = int( table->sizeMaxY() * zoom() ) - height();
...
void KSpreadCanvas::slotMaxColumn( int _max_column )
{
  ...
  const int _sizeMaxX = int( activeTable()->sizeMaxX() * zoom() );
...
void KSpreadCanvas::slotMaxRow( int _max_row )
{
  ...
  unsigned long _sizeMaxY = int( activeTable()->sizeMaxY() * zoom() );
