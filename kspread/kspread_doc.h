...
public:
  ...
  ~KSpreadDoc();
    ...
    enum { STYLE_PAGE = 20, STYLE_COLUMN, STYLE_ROW, STYLE_CELL, STYLE_PAGEMASTER, STYLE_USERSTYLE, STYLE_DEFAULTSTYLE,  STYLE_NUMERIC_PERCENTAGE, STYLE_NUMERIC_CURRENCY, STYLE_NUMERIC_FRACTION, STYLE_NUMERIC_SCIENTIFIC,  STYLE_NUMERIC_NUMBER};
