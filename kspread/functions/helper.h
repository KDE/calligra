 ...
 * 4: European 30 / 360
 */
CALLIGRA_TABLES_EXPORT int daysPerYear(QDate const & date, int basis);
 ...
 * 4: European 30 / 360
 */
CALLIGRA_TABLES_EXPORT int daysBetweenDates(QDate const & date1, QDate const & date2, int basis);


// ODF
CALLIGRA_TABLES_EXPORT int days360(const QDate& _date1, const QDate& _date2, bool european);
CALLIGRA_TABLES_EXPORT int days360(int day1, int month1, int year1, bool leapYear1, int  day2, int month2, int year2, bool leapYear2, bool usa);
CALLIGRA_TABLES_EXPORT long double yearFrac(const QDate& refDate, const QDate& startDate, const QDate& endDate, int basis);
