...
void KSpreadDlgFormula2::slotOk()
{
...
void KSpreadDlgFormula2::slotClose()
{
    m_pView->canvasWidget()->endChoose();
...
void KSpreadDlgFormula2::slotDoubleClicked(QListBoxItem *)
{
    m_focus=0;
...
void KSpreadDlgFormula2::slotSelectionChanged( KSpreadTable* _table, const QRect& _selection )
{
    if ( !m_focus )
	return;
...
void KSpreadDlgFormula2::slotActivated(const QString & string)
{
...
void KSpreadDlgFormula2::changeFunction()
{
    param tmp;
    tmp.nb_param=0;
    tmp.multiple=false;
...
#include "kspread_dlg_formula2.moc"
