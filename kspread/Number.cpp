...
Number fabs (const Number &n) { return n.abs(); }
...
Number sqrt (const Number &n) { return n.pow (0.5); }
Number log (const Number &n, Number base) { return n.log (base); }
Number ln (const Number &n) { return n.ln (); }
Number log (const Number &n) { return n.ln (); }
Number log10 (const Number &n) { return n.log (10); }
Number exp (const Number &n) { return n.exp (); }
