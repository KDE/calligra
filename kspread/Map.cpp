...
bool Map::saveOdf( KoXmlWriter & xmlWriter, KoGenStyles & mainStyles, KoEmbeddedDocumentSaver &embeddedSaver, KoStore *store, KoXmlWriter* manifestWriter, int &_indexObj, int &_partIndexObj )
{
