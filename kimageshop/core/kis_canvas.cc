...
KImageShopCanvas::KImageShopCanvas( QWidget* parent, const char* name ) : QWidget( parent, name )
{
...
void KImageShopCanvas::enterEvent( QEvent*e )
{
  emit gotEnterEvent(e);
}

void KImageShopCanvas::leaveEvent( QEvent*e )
{
