/*
 *  kfloatingdialogowner.h - part of KImageShop
 *
...
#ifndef __kfloatingdialogowner_h__
#define __kfloatingdialogowner_h__

#include <qlist.h>
#include "kfloatingdialog.h"

class KFloatingDialogOwner
{
 public:
  KFloatingDialogOwner();
