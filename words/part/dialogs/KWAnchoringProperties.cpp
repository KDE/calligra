...
void KWAnchoringProperties::anchorTypeChanged(int type)
{
    ...
    vertRelStrings[2] = i18n(""); // KoTextAnchor::VFrame
    vertRelStrings[3] = i18n(""); // KoTextAnchor::VFrameContent
    ...
    vertRelStrings[9] = i18n(""); // KoTextAnchor::VText
    ...
    horizRelStrings[5] = i18n(""); // KoTextAnchor::HFrame
    horizRelStrings[6] = i18n(""); // KoTextAnchor::HFrameContent
    horizRelStrings[7] = i18n(""); // KoTextAnchor::HFrameEndMargin
    horizRelStrings[8] = i18n(""); // KoTextAnchor::HFrameStartMargin
