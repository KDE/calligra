...
void KWView::setupActions()
{
    ...
    m_actionAddBookmark = new QAction(koIcon("bookmark-new"), i18n("Bookmark..."), this);
    ...
    action = new QAction(i18n("Select All Shapes"), this);
    ...
    // -------------- Frame menu
    action  = new QAction(i18n("Create Linked Copy"), this);
    ...
    m_actionAddLinkToBookmak = new QAction(i18n("Add to Bookmark"), 0,
            this, SLOT(addToBookmark()),
            actionCollection(), "add_to_bookmark");

    m_actionAddBookmark= new QAction(i18n("Bookmark..."), 0,
            this, SLOT(addBookmark()),
            actionCollection(), "add_bookmark");
    m_actionSelectBookmark= new QAction(i18n("Select Bookmark..."), 0,
