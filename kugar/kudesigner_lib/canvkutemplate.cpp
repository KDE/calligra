...
CanvasBand * CanvasKugarTemplate::band( KuDesignerCanvasRtti type, int level )
{
    switch( type )
    {
        case KuDesignerRttiReportHeader:
            return reportHeader;
        case KuDesignerRttiPageHeader:
            return pageHeader;
        ...
        case KuDesignerRttiPageFooter:
            return pageFooter;
        case KuDesignerRttiReportFooter:
            return reportFooter;
        default:
            return 0;
    }
