...
{
    props.addProperty(new Property(KOProperty::Integer, "X1", i18n("X1"), x));

    props.addProperty(new Property(KOProperty::Integer, "Y1", i18n("Y1"), y));

    props.addProperty(new Property(KOProperty::Integer, "X2", i18n("X2"), x + width));

    props.addProperty(new Property(KOProperty::Integer, "Y2", i18n("Y2"), y + height));

    props.addProperty(new Property(KOProperty::Color, "Color", i18n("Color"), QColor(0,0,0)));

    props.addProperty(new Property(KOProperty::Integer, "Width", i18n("Width"), 1));

    props.addProperty(new Property(KOProperty::LineStyle, "Style", i18n("Line Style"), 1));
}
