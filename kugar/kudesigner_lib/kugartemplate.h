...
public:
    ...
    virtual int rtti() const { return Rtti_KugarTemplate; }
    virtual void draw(QPainter &painter);
    
    void arrangeSections(bool destructive = true);
    void updatePaperProps();

    QString fileName() const { return m_reportFileName; }
    void setFileName(const QString &fName) { m_reportFileName = fName; }
