    ...
    :Section(x, y, width, height, canvas)
{
    ...
    m["Tabloid"] = "29";
    m["NPageSize"] = "30";
    props.addProperty(new Property("PageSize", i18n("Page Size"), "", m, "0"));
    m.clear();

    m[i18n("Portrait")] = "0";
    m[i18n("Landscape")] = "1";
    props.addProperty(new Property("PageOrientation", i18n("Page Orientation"), "", m, "0"));
    m.clear();

    props.addProperty(new Property(KOProperty::Integer, "TopMargin", i18n("Top Margin"), 0));
    props.addProperty(new Property(KOProperty::Integer, "BottomMargin", i18n("Bottom Margin"), 0));
    props.addProperty(new Property(KOProperty::Integer, "LeftMargin", i18n("Left Margin"), 0));
    props.addProperty(new Property(KOProperty::Integer, "RightMargin", i18n("Right Margin"), 0));
}
