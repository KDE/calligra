/* This file is part of the KDE project
   ...
   Copyright 2013 Gopalakrishna Bhat A <gopalakbhat@gmail.com>
...
FormulaDocument::FormulaDocument( FormulaShape *parent )
...
bool FormulaDocument::loadOdf( KoOdfReadStore &odfStore )
{
    ...
    QDomDocument domDoc;
    bodyElement.asQDomNode(domDoc);

    d->parent->setMML(domDoc.toString());
    return true;
}
