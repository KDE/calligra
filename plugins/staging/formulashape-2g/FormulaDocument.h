...
#ifndef FORMULADOCUMENT_H
#define FORMULADOCUMENT_H

#include "qtmmlwidget/QtMmlDocument"
...
class FormulaDocument : public KoDocument, public QtMmlDocument
{
public:
