...
#include "plugins/pathshapes/rectangle/RectangleShapeConfigCommand.h"
...
class ViewPortShapeConfigCommand : public RectangleShapeConfigCommand
{
public:
    /**
     ...
     */
    ViewPortShapeConfigCommand(RectangleShape *rectangle, qreal cornerRadiusX, qreal cornerRadiusY, QUndoCommand *parent = 0);
    /// redo the command
  //  virtual void redo();
