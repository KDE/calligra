...
GMacroCommand::GMacroCommand(const QString &name) : GCommand(name) {
    m_commands.setAutoDelete(true);
}

void GMacroCommand::addCommand(GCommand *command) {
    m_commands.append(command);
}

void GMacroCommand::execute() {
