//
// Created: Tue Mar 19 12:03:09 2002
...
struct { int unicode; uchar pos; CharClass cl; char* latexName; } symbolFontMap[] = {
    { 0x2282, 204, BINOP, symbolFontMap_subset },
    { 0x2283, 201, BINOP, symbolFontMap_supset },
    { 0x2286, 205, BINOP, symbolFontMap_subseteq },
    { 0x2287, 202, BINOP, symbolFontMap_supseteq },
    ...
    { 0x003E, 62, RELATION, 0 },
    { 0x003D, 61, RELATION, 0 },
    { 0x003C, 60, RELATION, 0 },
    { 0x003B, 59, PUNCTUATION, 0 },
    { 0x003A, 58, PUNCTUATION, 0 },
    ...
    { 0x005B, 91, ORDINARY, 0 },
    { 0x005D, 93, ORDINARY, 0 },
