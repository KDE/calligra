...
class ServiceTypeRepository : virtual public CORBA::Object
{
  public:
    ...
    virtual IncarnationNumber add_type( const char* name, const char* if_name, const PropStructSeq& props, const ServiceTypeNameSeq& super_types ) = 0;
...
class ServiceTypeRepository_stub : virtual public ServiceTypeRepository
{
  public:
    ...
    IncarnationNumber incarnation();
    IncarnationNumber add_type( const char* name, const char* if_name, const PropStructSeq& props, const ServiceTypeNameSeq& super_types );
