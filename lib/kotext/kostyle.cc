...
QMap<KoStyle*, QString> KoStyleCollection::saveOasis( KoGenStyles& styles, int styleType ) const
{
    // Remember the style names (the automatic names generated by KoGenStyles)
    QMap<KoStyle*, QString> autoNames;
...
QString KoStyle::saveStyle( KoGenStyles& genStyles, int styleType, const QString& parentStyleName ) const
{
