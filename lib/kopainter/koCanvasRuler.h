 ...
 */
#if !defined KO_CANVAS_RULER_H_
#define KO_CANVAS_RULER_H_
...
class KoCanvasRuler : public QFrame { 
	Q_OBJECT
	typedef QFrame super;

public:
	KoCanvasRuler(Qt::Orientation, QWidget *parent = 0, const char *name = 0);
	virtual ~KoCanvasRuler();
