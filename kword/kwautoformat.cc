...
KWAutoFormat::KWAutoFormat(KWDocument *doc)
    : KoAutoFormat(doc)
{
    m_doc=doc;
}

void KWAutoFormat::doAutoDetectUrl( QTextCursor *textEditCursor, KoTextParag *parag,int index, const QString & word, KoTextObject *txtObj )
{
