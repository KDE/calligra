        ...
        : KWMailMergeDataSource( inst, parent )
{
    ...
    sampleRecord[ "Prefered address: Street" ] = QString( "preferedAddressStreet" );
    sampleRecord[ "Prefered address: Locality" ] = QString( "preferedAddressLocality" );
    sampleRecord[ "Prefered address: Region" ] = QString( "preferedAddressRegion" );
    sampleRecord[ "Prefered address: Postal code" ] = QString( "preferedAddressPostalCode" );
    sampleRecord[ "Prefered address: Country" ] = QString( "preferedAddressCountry" );
    sampleRecord[ "Prefered address: Label" ] = QString( "preferedAddressLabel" );
}
