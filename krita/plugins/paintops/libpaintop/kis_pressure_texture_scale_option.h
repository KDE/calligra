...
#ifndef KIS_PRESSURE_TEXTURE_SCALE_OPTION_H
#define KIS_PRESSURE_TEXTURE_SCALE_OPTION_H
 ...
 */
class PAINTOP_EXPORT KisPressureTextureScaleOption : public KisCurveOption
{
public:
    KisPressureTextureScaleOption();
