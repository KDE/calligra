...
#ifndef KIS_SAND_PAINTOP_SETTINGS_H_
#define KIS_SAND_PAINTOP_SETTINGS_H_
...
class KisSandPaintOpSettings : public KisPaintOpSettings
{

public:
    KisSandPaintOpSettings();
    virtual ~KisSandPaintOpSettings() {}
