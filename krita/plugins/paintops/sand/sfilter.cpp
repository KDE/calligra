...
bool SandFilter::applyFilter(qreal cursorX, qreal cursorY)
{
    qreal mass, drag;
    qreal fx, fy;
...
void SandFilter::initFilterPosition(qreal x, qreal y)
{
    m_filterX = x;
    m_filterY = y;
    m_prevX = x;
...
void SandFilter::setFixedAngles(qreal angleX, qreal angleY)
{
