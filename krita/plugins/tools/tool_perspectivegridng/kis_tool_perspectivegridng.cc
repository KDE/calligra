...
#include <canvas/kis_perspective_grid_managerng.h>
...
KisToolPerspectiveGridNG::KisToolPerspectiveGridNG(KoCanvasBase * canvas)
...
KisToolPerspectiveGridNG::~KisToolPerspectiveGridNG()
{
}

void KisToolPerspectiveGridNG::activate(ToolActivation toolActivation, const QSet<KoShape*> &shapes)
{
...
void KisToolPerspectiveGridNG::deactivate()
{
...
bool KisToolPerspectiveGridNG::mouseNear(const QPointF& mousep, const QPointF& point)
{
...
KisPerspectiveGridNodeSP KisToolPerspectiveGridNG::nodeNearPoint(KisSubPerspectiveGrid* grid, QPointF point)
{
...
void KisToolPerspectiveGridNG::mousePressEvent(KoPointerEvent *event)
{
...
void KisToolPerspectiveGridNG::mouseMoveEvent(KoPointerEvent *event)
{
...
void KisToolPerspectiveGridNG::mouseReleaseEvent(KoPointerEvent *event)
{
...
void KisToolPerspectiveGridNG::paint(QPainter& gc, const KoViewConverter &converter)
{
    Q_UNUSED(converter);
    if (m_internalMode == MODE_CREATION) {
        drawGridCreation(gc);
...
void KisToolPerspectiveGridNG::drawGridCreation(QPainter& gc)
{
...
void KisToolPerspectiveGridNG::drawSmallRectangle(QPainter& gc, const QPointF& p)
{
    gc.drawRect(p.x() - m_handleHalfSize, p.y() - m_handleHalfSize, m_handleSize, m_handleSize);
}

void KisToolPerspectiveGridNG::drawGrid(QPainter& gc)
{
    dbgPlugins << "drawGrid";
