...
void PatternDockerDock::setCanvasResourceProvider(KisCanvasResourceProvider* canvasResourceProvider)
{
    connect(canvasResourceProvider, SIGNAL(sigPatternChanged(KoPattern*)),
