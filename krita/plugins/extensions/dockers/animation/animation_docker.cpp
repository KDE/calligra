...
void AnimationDocker::updateLazyFrameIcon()
{
    ...
    m_lazyFrameAction->setIcon(cfg.lazyFrameCreationEnabled() ?
                               themedIcon("lazyframeOn") :
                               themedIcon("lazyframeOff"));
}
...
void AnimationDocker::slotUpdateIcons()
{
    ...
    m_previousKeyFrameAction->setIcon(themedIcon("prevkeyframe"));
    m_nextKeyFrameAction->setIcon(themedIcon("nextkeyframe"));

    m_firstFrameAction->setIcon(themedIcon("firstframe"));
    m_lastFrameAction->setIcon(themedIcon("lastframe"));
