...
#ifndef ANIMATOR_LIGHT_TABLE_H
#define ANIMATOR_LIGHT_TABLE_H

#include <QList>
#include <QObject>

class AnimatorLightTable : public QObject
{
    Q_OBJECT
    
public:
    AnimatorLightTable();
    virtual ~AnimatorLightTable();
