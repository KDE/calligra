        ...
        : KisViewPlugin(parent)
{
    ...
    action  = new KisAction(themedIcon("object-rotate-right"), i18nc("rotate image 90 degrees to the right", "Rotate Image 90° to the Right"), this);
    action->setActivationFlags(KisAction::ACTIVE_NODE);
    ...
    action  = new KisAction(themedIcon("object-rotate-left"), i18nc("rotate image 90 degrees to the left", "Rotate Image 90° to the Left"), this);
    action->setActivationFlags(KisAction::ACTIVE_NODE);
