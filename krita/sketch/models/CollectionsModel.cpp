...
void CollectionsModel::initTemplates() {
    QString templateType = "krita_template";
...
QObject *CollectionsModel::recentFileManager() const
{
    return d->recentFileManager;
}

void CollectionsModel::setRecentFileManager(QObject *recentFileManager)
{
...
void CollectionsModel::recentFilesListChanged()
{
    reset();
}

void CollectionsModel::addRecent(const QString &_url)
{
    if (d->recentFileManager)
