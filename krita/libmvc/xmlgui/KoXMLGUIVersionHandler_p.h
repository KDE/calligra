...
#ifndef KoXMLGUIVERSIONHANDLER_P_H
#define KoXMLGUIVERSIONHANDLER_P_H

#include <QStringList>

/**
 * @internal
 * Helper class for KoXMLGUIClient::setXMLFile
 ...
 */
class KoXmlGuiVersionHandler
{
public:
    KoXmlGuiVersionHandler(const QStringList& files);
...
#endif /* KoXMLGUIVERSIONHANDLER_P_H */
