...
*/
#ifndef KoXMLGUIBuilder_h
#define KoXMLGUIBuilder_h
 ...
 * a need to derive from KoXMLGUIBuilder anymore.
 */
class KDEUI_EXPORT KoXMLGUIBuilder
{
 public:

  explicit KoXMLGUIBuilder( QWidget *widget );
  virtual ~KoXMLGUIBuilder();

  /* @internal */
  KoXMLGUIClient *builderClient() const;
  /* @internal */
  void setBuilderClient( KoXMLGUIClient *client );
  /* @internal */
...
private:
  KoXMLGUIBuilderPrivate * const d;
};
