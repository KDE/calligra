...
{
public:
    KisResourcesSnapshot(KisImageWSP image, KisNodeSP currentNode, KisPostExecutionUndoAdapter *undoAdapter,
                         KoCanvasResourceManager *resourceManager, KisDefaultBoundsBaseSP bounds = 0);
