...
*/
#ifndef KoXMLGuiFactory_p_h
#define KoXMLGuiFactory_p_h
...
struct ContainerNode
{
    ContainerNode( QWidget *_container, const QString &_tagName, const QString &_name,
                   ContainerNode *_parent = 0L, KoXMLGUIClient *_client = 0L,
                   KoXMLGUIBuilder *_builder = 0L, QAction* containerAction = 0,
    ...
    ContainerNode *findContainer( const QString &name, const QString &tagName,
                                  ...
                                  KoXMLGUIClient *currClient );

    ContainerClient *findChildContainerClient( KoXMLGUIClient *currentGUIClient,
...
private:
    ...
    QWidget *createContainer( QWidget *parent, int index, const QDomElement &element,
                              QAction*& containerAction, KoXMLGUIBuilder **builder );
