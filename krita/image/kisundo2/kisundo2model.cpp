...
KisUndo2Model::KisUndo2Model(QObject *parent)
...
QItemSelectionModel *KisUndo2Model::selectionModel() const
{
    return m_sel_model;
}

KisUndo2QStack *KisUndo2Model::stack() const
{
    return m_stack;
}

void KisUndo2Model::setStack(KisUndo2QStack *stack)
{
    if (m_stack == stack)
        return;
...
void KisUndo2Model::stackDestroyed(QObject *obj)
{
    if (obj != m_stack)
        return;
    m_stack = 0;
...
void KisUndo2Model::stackChanged()
{
    reset();
    m_sel_model->setCurrentIndex(selectedIndex(), QItemSelectionModel::ClearAndSelect);
}

void KisUndo2Model::setStackCurrentIndex(const QModelIndex &index)
{
    if (m_stack == 0)
        return;
...
QModelIndex KisUndo2Model::selectedIndex() const
{
    return m_stack == 0 ? QModelIndex() : createIndex(m_stack->index(), 0);
}

QModelIndex KisUndo2Model::index(int row, int column, const QModelIndex &parent) const
{
    if (m_stack == 0)
        return QModelIndex();
...
QModelIndex KisUndo2Model::parent(const QModelIndex&) const
{
    return QModelIndex();
}

int KisUndo2Model::rowCount(const QModelIndex &parent) const
{
    if (m_stack == 0)
        return 0;
...
int KisUndo2Model::columnCount(const QModelIndex&) const
{
    return 1;
}

QVariant KisUndo2Model::data(const QModelIndex &index, int role) const
{
    if (m_stack == 0)
        return QVariant();
...
QString KisUndo2Model::emptyLabel() const
{
    return m_emty_label;
}

void KisUndo2Model::setEmptyLabel(const QString &label)
{
    m_emty_label = label;
    stackChanged();
}

void KisUndo2Model::setCleanIcon(const QIcon &icon)
{
    m_clean_icon = icon;
    stackChanged();
}

QIcon KisUndo2Model::cleanIcon() const
{
    return m_clean_icon;
}
