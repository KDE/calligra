                      ...
                      BCtype_s xBC, BCtype_s yBC, float *data)
{
    ...
    int Mx, My, Nx, Ny;
    if (xBC.lCode == PERIODIC) {
        Mx = x_grid->num_points - 1;
    } else {
        Mx = x_grid->num_points;
    }
    if (yBC.lCode == PERIODIC) {
        My = y_grid->num_points - 1;
    } else {
        My = y_grid->num_points;
    }
                      ...
                      BCtype_s xBC, BCtype_s yBC, BCtype_s zBC, float *data)
{
    ...
    if (zBC.lCode == PERIODIC) {
        Mz = z_grid->num_points - 1;
    } else {
        Mz = z_grid->num_points;
    }
