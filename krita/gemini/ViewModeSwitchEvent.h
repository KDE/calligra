...
class ViewModeSwitchEvent : public QEvent
{
    public:
        ...
        inline QObject* fromView() const { return m_fromView; }
        inline QObject* toView() const { return m_toView; }

        inline ViewModeSynchronisationObject* synchronisationObject() const { return m_syncObject; }
