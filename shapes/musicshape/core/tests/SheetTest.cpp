...
void SheetTest::testConstruction()
{
...
void SheetTest::testRemovePart_index()
{
    sheet->addPart("part1");
    Part* p2 = sheet->addPart("part2");
    sheet->removePart(0);
...
void SheetTest::testRemovePart_part()
{
    Part* p1 = sheet->addPart("part1");
    Part* p2 = sheet->addPart("part2");
    sheet->removePart(p1);
...
void SheetTest::testAddPartGroup()
{
...
void SheetTest::testRemovePartGroup()
{
    sheet->addPart("part 1");
    sheet->addPart("part 2");
