...
int getPropertyFlags( const QPtrList<KPObject> &list )
{
    ...
    for ( ; it.current() ; ++it )
    {
        ...
        {
            case OT_LINE:
                flags |= PtPen | PtLineEnds | PtOther;
                break;
            case OT_FREEHAND:
                flags |= PtPen | PtOther;
            ...
            case OT_PIE:
                ...
                break;
            case OT_RECT:
                flags |= PtPen | PtBrush | PtRectangle;
                break;
            case OT_POLYGON:
                flags |= PtPen | PtBrush | PtPolygon;
                break;
            case OT_PART:
            case OT_ELLIPSE:
            case OT_TEXT:
            case OT_CLOSED_LINE:
            case OT_AUTOFORM:
                flags |= PtPen | PtBrush | PtOther;
                break;
            case OT_CLIPART:
            case OT_PICTURE:
                flags |= PtPen | PtBrush | PtPicture;
                break;
            case OT_GROUP:
                {
                    ...
                    if(obj)
                    {
                        flags |= getPropertyFlags( obj->objectList() );
                    }
                }
                break;
            default:
