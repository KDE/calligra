...
/*========================= save =================================*/
QDomDocumentFragment KPFreehandObject::save( QDomDocument& doc )
{
...
/*========================== load ================================*/
void KPFreehandObject::load( const QDomElement &element )
{
...
/*========================= draw =================================*/
void KPFreehandObject::draw( QPainter *_painter, int _diffx, int _diffy )
{
    if ( move ) {
...
/*===================== get angle ================================*/
float KPFreehandObject::getAngle( QPoint p1, QPoint p2 )
{
    float _angle = 0.0;
...
/*======================== paint =================================*/
void KPFreehandObject::paint( QPainter* _painter )
{
    int _w = pen.width();
...
void KPFreehandObject::resizeBy( int _dx, int _dy )
{
