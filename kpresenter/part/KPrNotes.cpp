...
, m_imageCollection( new KoImageCollection() )
{
    ...
    Q_ASSERT(factory);
    m_textShape = factory->createDefaultShape(m_doc->dataCenterMap(), m_doc->resourceManager());
    ...
    Q_ASSERT(factory);
    m_thumbnailShape = factory->createDefaultShape(m_doc->dataCenterMap(), m_doc->resourceManager());
