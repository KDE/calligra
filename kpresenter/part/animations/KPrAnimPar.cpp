...
bool KPrAnimPar::loadOdf(const KoXmlElement &element, KoShapeLoadingContext &context)
{
    KoXmlElement e;
...
void KPrAnimPar::init(KPrAnimationCache *animationCache, int step) const
{
