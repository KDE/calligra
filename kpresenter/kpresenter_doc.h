...
class KPresenterDoc : public KoDocument
{
  ...
  public:
    ...
    enum { STYLE_PAGELAYOUT, STYLE_USER, STYLE_AUTO, STYLE_BACKGROUNDPAGE, STYLE_BACKGROUNDPAGEAUTO,STYLE_GRAPHICAUTO, STYLE_HATCH, STYLE_GRADIENT,STYLE_OBJECTANIMATION };
