...
enum ObjType { OT_PICTURE = 0, OT_LINE = 1, OT_RECT = 2, OT_ELLIPSE = 3, OT_TEXT = 4, OT_AUTOFORM = 5, OT_CLIPART = 6, OT_UNDEFINED = 7, OT_PIE = 8, \
               OT_PART };
...
enum Effect3 { EF3_NONE = 0, EF3_GO_RIGHT = 1, EF3_GO_LEFT = 2, EF3_GO_TOP = 3, EF3_GO_BOTTOM = 4, EF3_GO_RIGHT_TOP = 5, \
               EF3_GO_RIGHT_BOTTOM = 6, EF3_GO_LEFT_TOP = 7, EF3_GO_LEFT_BOTTOM = 8, EF3_WIPE_LEFT = 9, EF3_WIPE_RIGHT = 10, \
               EF3_WIPE_TOP = 11, EF3_WIPE_BOTTOM = 12 };
enum PageEffect { PEF_NONE = 0, PEF_CLOSE_HORZ = 1, PEF_CLOSE_VERT = 2, PEF_CLOSE_ALL = 3, PEF_OPEN_HORZ = 4, PEF_OPEN_VERT = 5, \
                  ...
                  PEF_INTERLOCKING_VERT_2 = 10, PEF_SURROUND1 = 11, PEF_FLY1 = 12 };
...
enum PresentSlides { PS_ALL = 0, PS_CURRENT = 1, PS_SELECTED = 2 };
