...
/*========================= save =================================*/
QDomDocumentFragment KPCubicBezierCurveObject::save( QDomDocument& doc )
{
...
/*========================== load ================================*/
void KPCubicBezierCurveObject::load(const QDomElement &element)
{
...
/*========================= draw =================================*/
void KPCubicBezierCurveObject::draw( QPainter *_painter, int _diffx, int _diffy )
{
    if ( move ) {
