...
#include "/usr/local/kde/idl/kom.h"

#include "/usr/local/kde/idl/controls.h"

#include "/usr/local/kde/idl/parts.h"
  ...
  virtual public ::OPParts::View
{
  public:
    ...
    virtual void insertLineH() = 0;
    virtual void insertLineV() = 0;
    virtual void insertLineD1() = 0;
    virtual void insertLineD2() = 0;
    virtual void insertNormRect() = 0;
    virtual void insertRoundRect() = 0;
